...
struct DmaDescriptor {
    reserved: u32,        // 0x0 Reserved.
    source_end_addr: u32, // 0x4 Source data end address.
    dest_end_addr: u32,   // 0x8 Destination end address.
    next_desc: u32,       // 0xC Link to next descriptor.
}
