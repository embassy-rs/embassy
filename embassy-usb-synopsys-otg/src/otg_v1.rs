...
impl Dcfg {
    #[doc = "Device speed"]
    #[inline(always)]
    pub const fn dspd(&self) -> Dspd {
        let val = (self.0 >> 0usize) & 0x03;
        Dspd::from_bits(val as u8)
    }
    #[doc = "Device speed"]
    #[inline(always)]
    pub fn set_dspd(&mut self, val: Dspd) {
    ...
    #[inline(always)]
    pub const fn pfivl(&self) -> Pfivl {
        let val = (self.0 >> 11usize) & 0x03;
        Pfivl::from_bits(val as u8)
    }
    #[doc = "Periodic frame interval"]
    #[inline(always)]
    pub fn set_pfivl(&mut self, val: Pfivl) {
...
impl Dsts {
    ...
    #[inline(always)]
    pub const fn enumspd(&self) -> Dspd {
        let val = (self.0 >> 1usize) & 0x03;
        Dspd::from_bits(val as u8)
    }
    #[doc = "Enumerated speed"]
    #[inline(always)]
    pub fn set_enumspd(&mut self, val: Dspd) {
