...
- **Hardware Abstraction Layers**
    ...
    - [embassy-efm32](https://docs.embassy.dev/embassy-efm32/), for the Silicon Labs EFM32 (Gecko) microcontrollers.
...
* `examples/efm32gg` run on the Bosch XDK110 (EFM32GG390F1024), flashed through its USB bootloader.
