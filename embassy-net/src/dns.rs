...
use heapless::Vec;
pub use sporktcp::socket::dns::{DnsQuery, Socket};
pub(crate) use sporktcp::socket::dns::{GetQueryResultError, StartQueryError};
pub use sporktcp::wire::{DnsQueryType, IpAddress};
...
impl<'a> DnsSocket<'a> {
    ...
    pub async fn query(
        ...
        name: &str,
        qtype: DnsQueryType,
    ) -> Result<Vec<IpAddress, { sporktcp::config::DNS_MAX_RESULT_COUNT }>, Error> {
