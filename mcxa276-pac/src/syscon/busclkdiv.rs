#[doc = "Register `BUSCLKDIV` reader"]
pub type R = crate::R<BusclkdivSpec>;
#[doc = "Register `BUSCLKDIV` writer"]
pub type W = crate::W<BusclkdivSpec>;
...
impl W {
    #[doc = "Bit 29 - Resets the divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<BusclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<BusclkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "BUS_CLK Clock Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`busclkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`busclkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BusclkdivSpec;
impl crate::RegisterSpec for BusclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`busclkdiv::R`](R) reader structure"]
impl crate::Readable for BusclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`busclkdiv::W`](W) writer structure"]
impl crate::Writable for BusclkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUSCLKDIV to value 0x01"]
impl crate::Resettable for BusclkdivSpec {
