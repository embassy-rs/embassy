#[doc = "Register `PLL1CLKDIV` reader"]
pub type R = crate::R<Pll1clkdivSpec>;
#[doc = "Register `PLL1CLKDIV` writer"]
pub type W = crate::W<Pll1clkdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<Pll1clkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<Pll1clkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<Pll1clkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "PLL1_CLK_DIV Clock Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`pll1clkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll1clkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pll1clkdivSpec;
impl crate::RegisterSpec for Pll1clkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll1clkdiv::R`](R) reader structure"]
impl crate::Readable for Pll1clkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`pll1clkdiv::W`](W) writer structure"]
impl crate::Writable for Pll1clkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PLL1CLKDIV to value 0x4000_0000"]
impl crate::Resettable for Pll1clkdivSpec {
