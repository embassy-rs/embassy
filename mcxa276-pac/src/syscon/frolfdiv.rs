#[doc = "Register `FROLFDIV` reader"]
pub type R = crate::R<FrolfdivSpec>;
#[doc = "Register `FROLFDIV` writer"]
pub type W = crate::W<FrolfdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<FrolfdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<FrolfdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<FrolfdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct FrolfdivSpec;
impl crate::RegisterSpec for FrolfdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`frolfdiv::R`](R) reader structure"]
impl crate::Readable for FrolfdivSpec {}
#[doc = "`write(|w| ..)` method takes [`frolfdiv::W`](W) writer structure"]
impl crate::Writable for FrolfdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FROLFDIV to value 0x4000_0000"]
impl crate::Resettable for FrolfdivSpec {
