...
impl W {
    #[doc = "Bit 0 - Arm X"]
    #[inline(always)]
    pub fn armx(&mut self) -> ArmxW<Sm3captctrlxSpec> {
        ArmxW::new(self, 0)
    }
    #[doc = "Bit 1 - One Shot Mode Aux"]
    #[inline(always)]
    pub fn oneshotx(&mut self) -> OneshotxW<Sm3captctrlxSpec> {
        OneshotxW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Edge X 0"]
    #[inline(always)]
    pub fn edgx0(&mut self) -> Edgx0W<Sm3captctrlxSpec> {
        Edgx0W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Edge X 1"]
    #[inline(always)]
    pub fn edgx1(&mut self) -> Edgx1W<Sm3captctrlxSpec> {
        Edgx1W::new(self, 4)
    }
    #[doc = "Bit 6 - Input Select X"]
    #[inline(always)]
    pub fn inp_selx(&mut self) -> InpSelxW<Sm3captctrlxSpec> {
        InpSelxW::new(self, 6)
    }
    #[doc = "Bit 7 - Edge Counter X Enable"]
    #[inline(always)]
    pub fn edgcntx_en(&mut self) -> EdgcntxEnW<Sm3captctrlxSpec> {
        EdgcntxEnW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Capture X FIFOs Water Mark"]
    #[inline(always)]
    pub fn cfxwm(&mut self) -> CfxwmW<Sm3captctrlxSpec> {
        CfxwmW::new(self, 8)
    }
}
