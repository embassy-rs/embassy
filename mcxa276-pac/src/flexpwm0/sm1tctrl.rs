#[doc = "Register `SM1TCTRL` reader"]
pub type R = crate::R<Sm1tctrlSpec>;
#[doc = "Register `SM1TCTRL` writer"]
pub type W = crate::W<Sm1tctrlSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Output Trigger Enables"]
    #[inline(always)]
    pub fn out_trig_en(&mut self) -> OutTrigEnW<Sm1tctrlSpec> {
        OutTrigEnW::new(self, 0)
    }
    #[doc = "Bit 12 - Trigger Frequency"]
    #[inline(always)]
    pub fn trgfrq(&mut self) -> TrgfrqW<Sm1tctrlSpec> {
        TrgfrqW::new(self, 12)
    }
    #[doc = "Bit 14 - Mux Output Trigger 1 Source Select"]
    #[inline(always)]
    pub fn pwbot1(&mut self) -> Pwbot1W<Sm1tctrlSpec> {
        Pwbot1W::new(self, 14)
    }
    #[doc = "Bit 15 - Mux Output Trigger 0 Source Select"]
    #[inline(always)]
    pub fn pwaot0(&mut self) -> Pwaot0W<Sm1tctrlSpec> {
        Pwaot0W::new(self, 15)
    }
}
...
pub struct Sm1tctrlSpec;
impl crate::RegisterSpec for Sm1tctrlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm1tctrl::R`](R) reader structure"]
impl crate::Readable for Sm1tctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sm1tctrl::W`](W) writer structure"]
impl crate::Writable for Sm1tctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM1TCTRL to value 0"]
impl crate::Resettable for Sm1tctrlSpec {}
