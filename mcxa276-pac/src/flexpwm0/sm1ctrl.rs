#[doc = "Register `SM1CTRL` reader"]
pub type R = crate::R<Sm1ctrlSpec>;
#[doc = "Register `SM1CTRL` writer"]
pub type W = crate::W<Sm1ctrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Double Switching Enable"]
    #[inline(always)]
    pub fn dblen(&mut self) -> DblenW<Sm1ctrlSpec> {
        DblenW::new(self, 0)
    }
    #[doc = "Bit 1 - PWM_X Double Switching Enable"]
    #[inline(always)]
    pub fn dblx(&mut self) -> DblxW<Sm1ctrlSpec> {
        DblxW::new(self, 1)
    }
    #[doc = "Bit 2 - Load Mode Select"]
    #[inline(always)]
    pub fn ldmod(&mut self) -> LdmodW<Sm1ctrlSpec> {
        LdmodW::new(self, 2)
    }
    #[doc = "Bit 3 - Split the DBLPWM signal to PWM_A and PWM_B"]
    #[inline(always)]
    pub fn split(&mut self) -> SplitW<Sm1ctrlSpec> {
        SplitW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Prescaler"]
    #[inline(always)]
    pub fn prsc(&mut self) -> PrscW<Sm1ctrlSpec> {
        PrscW::new(self, 4)
    }
    #[doc = "Bit 7 - Compare Mode"]
    #[inline(always)]
    pub fn compmode(&mut self) -> CompmodeW<Sm1ctrlSpec> {
        CompmodeW::new(self, 7)
    }
    #[doc = "Bit 10 - Full Cycle Reload"]
    #[inline(always)]
    pub fn full(&mut self) -> FullW<Sm1ctrlSpec> {
        FullW::new(self, 10)
    }
    #[doc = "Bit 11 - Half Cycle Reload"]
    #[inline(always)]
    pub fn half(&mut self) -> HalfW<Sm1ctrlSpec> {
        HalfW::new(self, 11)
    }
    #[doc = "Bits 12:15 - Load Frequency"]
    #[inline(always)]
    pub fn ldfq(&mut self) -> LdfqW<Sm1ctrlSpec> {
        LdfqW::new(self, 12)
    }
}
#[doc = "Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm1ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm1ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm1ctrlSpec;
impl crate::RegisterSpec for Sm1ctrlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm1ctrl::R`](R) reader structure"]
impl crate::Readable for Sm1ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sm1ctrl::W`](W) writer structure"]
impl crate::Writable for Sm1ctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM1CTRL to value 0x0400"]
impl crate::Resettable for Sm1ctrlSpec {
