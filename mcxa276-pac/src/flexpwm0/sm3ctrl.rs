#[doc = "Register `SM3CTRL` reader"]
pub type R = crate::R<Sm3ctrlSpec>;
#[doc = "Register `SM3CTRL` writer"]
pub type W = crate::W<Sm3ctrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Double Switching Enable"]
    #[inline(always)]
    pub fn dblen(&mut self) -> DblenW<Sm3ctrlSpec> {
        DblenW::new(self, 0)
    }
    #[doc = "Bit 1 - PWM_X Double Switching Enable"]
    #[inline(always)]
    pub fn dblx(&mut self) -> DblxW<Sm3ctrlSpec> {
        DblxW::new(self, 1)
    }
    #[doc = "Bit 2 - Load Mode Select"]
    #[inline(always)]
    pub fn ldmod(&mut self) -> LdmodW<Sm3ctrlSpec> {
        LdmodW::new(self, 2)
    }
    #[doc = "Bit 3 - Split the DBLPWM signal to PWM_A and PWM_B"]
    #[inline(always)]
    pub fn split(&mut self) -> SplitW<Sm3ctrlSpec> {
        SplitW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Prescaler"]
    #[inline(always)]
    pub fn prsc(&mut self) -> PrscW<Sm3ctrlSpec> {
        PrscW::new(self, 4)
    }
    #[doc = "Bit 7 - Compare Mode"]
    #[inline(always)]
    pub fn compmode(&mut self) -> CompmodeW<Sm3ctrlSpec> {
        CompmodeW::new(self, 7)
    }
    #[doc = "Bit 10 - Full Cycle Reload"]
    #[inline(always)]
    pub fn full(&mut self) -> FullW<Sm3ctrlSpec> {
        FullW::new(self, 10)
    }
    #[doc = "Bit 11 - Half Cycle Reload"]
    #[inline(always)]
    pub fn half(&mut self) -> HalfW<Sm3ctrlSpec> {
        HalfW::new(self, 11)
    }
    #[doc = "Bits 12:15 - Load Frequency"]
    #[inline(always)]
    pub fn ldfq(&mut self) -> LdfqW<Sm3ctrlSpec> {
        LdfqW::new(self, 12)
    }
}
...
pub struct Sm3ctrlSpec;
impl crate::RegisterSpec for Sm3ctrlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm3ctrl::R`](R) reader structure"]
impl crate::Readable for Sm3ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sm3ctrl::W`](W) writer structure"]
impl crate::Writable for Sm3ctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM3CTRL to value 0x0400"]
impl crate::Resettable for Sm3ctrlSpec {
