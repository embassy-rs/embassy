#[doc = "Register `SM3STS` reader"]
pub type R = crate::R<Sm3stsSpec>;
#[doc = "Register `SM3STS` writer"]
pub type W = crate::W<Sm3stsSpec>;
#[doc = "Compare Flags\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:5 - Compare Flags"]
    #[inline(always)]
    pub fn cmpf(&mut self) -> CmpfW<Sm3stsSpec> {
        CmpfW::new(self, 0)
    }
    #[doc = "Bit 6 - Capture Flag X0"]
    #[inline(always)]
    pub fn cfx0(&mut self) -> Cfx0W<Sm3stsSpec> {
        Cfx0W::new(self, 6)
    }
    #[doc = "Bit 7 - Capture Flag X1"]
    #[inline(always)]
    pub fn cfx1(&mut self) -> Cfx1W<Sm3stsSpec> {
        Cfx1W::new(self, 7)
    }
    #[doc = "Bit 12 - Reload Flag"]
    #[inline(always)]
    pub fn rf(&mut self) -> RfW<Sm3stsSpec> {
        RfW::new(self, 12)
    }
    #[doc = "Bit 13 - Reload Error Flag"]
    #[inline(always)]
    pub fn ref_(&mut self) -> RefW<Sm3stsSpec> {
        RefW::new(self, 13)
    }
}
...
pub struct Sm3stsSpec;
impl crate::RegisterSpec for Sm3stsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm3sts::R`](R) reader structure"]
impl crate::Readable for Sm3stsSpec {}
#[doc = "`write(|w| ..)` method takes [`sm3sts::W`](W) writer structure"]
impl crate::Writable for Sm3stsSpec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0x30ff;
}
#[doc = "`reset()` method sets SM3STS to value 0"]
impl crate::Resettable for Sm3stsSpec {}
