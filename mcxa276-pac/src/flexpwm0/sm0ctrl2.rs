#[doc = "Register `SM0CTRL2` reader"]
pub type R = crate::R<Sm0ctrl2Spec>;
#[doc = "Register `SM0CTRL2` writer"]
pub type W = crate::W<Sm0ctrl2Spec>;
...
impl W {
    #[doc = "Bits 0:1 - Clock Source Select"]
    #[inline(always)]
    pub fn clk_sel(&mut self) -> ClkSelW<Sm0ctrl2Spec> {
        ClkSelW::new(self, 0)
    }
    #[doc = "Bit 2 - Reload Source Select"]
    #[inline(always)]
    pub fn reload_sel(&mut self) -> ReloadSelW<Sm0ctrl2Spec> {
        ReloadSelW::new(self, 2)
    }
    #[doc = "Bits 3:5 - Force Select"]
    #[inline(always)]
    pub fn force_sel(&mut self) -> ForceSelW<Sm0ctrl2Spec> {
        ForceSelW::new(self, 3)
    }
    #[doc = "Bit 6 - Force Initialization"]
    #[inline(always)]
    pub fn force(&mut self) -> ForceW<Sm0ctrl2Spec> {
        ForceW::new(self, 6)
    }
    #[doc = "Bit 7 - Force Enable"]
    #[inline(always)]
    pub fn frcen(&mut self) -> FrcenW<Sm0ctrl2Spec> {
        FrcenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Initialization Control Select"]
    #[inline(always)]
    pub fn init_sel(&mut self) -> InitSelW<Sm0ctrl2Spec> {
        InitSelW::new(self, 8)
    }
    #[doc = "Bit 10 - PWM_X Initial Value"]
    #[inline(always)]
    pub fn pwmx_init(&mut self) -> PwmxInitW<Sm0ctrl2Spec> {
        PwmxInitW::new(self, 10)
    }
    #[doc = "Bit 11 - PWM45 Initial Value"]
    #[inline(always)]
    pub fn pwm45_init(&mut self) -> Pwm45InitW<Sm0ctrl2Spec> {
        Pwm45InitW::new(self, 11)
    }
    #[doc = "Bit 12 - PWM23 Initial Value"]
    #[inline(always)]
    pub fn pwm23_init(&mut self) -> Pwm23InitW<Sm0ctrl2Spec> {
        Pwm23InitW::new(self, 12)
    }
    #[doc = "Bit 13 - Independent or Complementary Pair Operation"]
    #[inline(always)]
    pub fn indep(&mut self) -> IndepW<Sm0ctrl2Spec> {
        IndepW::new(self, 13)
    }
    #[doc = "Bit 15 - Debug Enable"]
    #[inline(always)]
    pub fn dbgen(&mut self) -> DbgenW<Sm0ctrl2Spec> {
        DbgenW::new(self, 15)
    }
}
#[doc = "Control 2 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm0ctrl2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm0ctrl2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm0ctrl2Spec;
impl crate::RegisterSpec for Sm0ctrl2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm0ctrl2::R`](R) reader structure"]
impl crate::Readable for Sm0ctrl2Spec {}
#[doc = "`write(|w| ..)` method takes [`sm0ctrl2::W`](W) writer structure"]
impl crate::Writable for Sm0ctrl2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM0CTRL2 to value 0"]
impl crate::Resettable for Sm0ctrl2Spec {}
