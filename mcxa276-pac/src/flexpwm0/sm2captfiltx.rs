#[doc = "Register `SM2CAPTFILTX` reader"]
pub type R = crate::R<Sm2captfiltxSpec>;
#[doc = "Register `SM2CAPTFILTX` writer"]
pub type W = crate::W<Sm2captfiltxSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Input Capture Filter Period"]
    #[inline(always)]
    pub fn captx_filt_per(&mut self) -> CaptxFiltPerW<Sm2captfiltxSpec> {
        CaptxFiltPerW::new(self, 0)
    }
    #[doc = "Bits 8:10 - Input Capture Filter Count"]
    #[inline(always)]
    pub fn captx_filt_cnt(&mut self) -> CaptxFiltCntW<Sm2captfiltxSpec> {
...
pub struct Sm2captfiltxSpec;
impl crate::RegisterSpec for Sm2captfiltxSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm2captfiltx::R`](R) reader structure"]
impl crate::Readable for Sm2captfiltxSpec {}
#[doc = "`write(|w| ..)` method takes [`sm2captfiltx::W`](W) writer structure"]
impl crate::Writable for Sm2captfiltxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM2CAPTFILTX to value 0"]
impl crate::Resettable for Sm2captfiltxSpec {}
