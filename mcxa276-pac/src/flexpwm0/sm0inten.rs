#[doc = "Register `SM0INTEN` reader"]
pub type R = crate::R<Sm0intenSpec>;
#[doc = "Register `SM0INTEN` writer"]
pub type W = crate::W<Sm0intenSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Compare Interrupt Enables"]
    #[inline(always)]
    pub fn cmpie(&mut self) -> CmpieW<Sm0intenSpec> {
        CmpieW::new(self, 0)
    }
    #[doc = "Bit 6 - Capture X 0 Interrupt Enable"]
    #[inline(always)]
    pub fn cx0ie(&mut self) -> Cx0ieW<Sm0intenSpec> {
        Cx0ieW::new(self, 6)
    }
    #[doc = "Bit 7 - Capture X 1 Interrupt Enable"]
    #[inline(always)]
    pub fn cx1ie(&mut self) -> Cx1ieW<Sm0intenSpec> {
        Cx1ieW::new(self, 7)
    }
    #[doc = "Bit 12 - Reload Interrupt Enable"]
    #[inline(always)]
    pub fn rie(&mut self) -> RieW<Sm0intenSpec> {
        RieW::new(self, 12)
    }
    #[doc = "Bit 13 - Reload Error Interrupt Enable"]
    #[inline(always)]
    pub fn reie(&mut self) -> ReieW<Sm0intenSpec> {
        ReieW::new(self, 13)
    }
}
#[doc = "Interrupt Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm0inten::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm0inten::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm0intenSpec;
impl crate::RegisterSpec for Sm0intenSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm0inten::R`](R) reader structure"]
impl crate::Readable for Sm0intenSpec {}
#[doc = "`write(|w| ..)` method takes [`sm0inten::W`](W) writer structure"]
impl crate::Writable for Sm0intenSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM0INTEN to value 0"]
impl crate::Resettable for Sm0intenSpec {}
