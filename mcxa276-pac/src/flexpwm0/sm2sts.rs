#[doc = "Register `SM2STS` reader"]
pub type R = crate::R<Sm2stsSpec>;
#[doc = "Register `SM2STS` writer"]
pub type W = crate::W<Sm2stsSpec>;
#[doc = "Compare Flags\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:5 - Compare Flags"]
    #[inline(always)]
    pub fn cmpf(&mut self) -> CmpfW<Sm2stsSpec> {
        CmpfW::new(self, 0)
    }
    #[doc = "Bit 6 - Capture Flag X0"]
    #[inline(always)]
    pub fn cfx0(&mut self) -> Cfx0W<Sm2stsSpec> {
        Cfx0W::new(self, 6)
    }
    #[doc = "Bit 7 - Capture Flag X1"]
    #[inline(always)]
    pub fn cfx1(&mut self) -> Cfx1W<Sm2stsSpec> {
        Cfx1W::new(self, 7)
    }
    #[doc = "Bit 12 - Reload Flag"]
    #[inline(always)]
    pub fn rf(&mut self) -> RfW<Sm2stsSpec> {
        RfW::new(self, 12)
    }
    #[doc = "Bit 13 - Reload Error Flag"]
    #[inline(always)]
    pub fn ref_(&mut self) -> RefW<Sm2stsSpec> {
        RefW::new(self, 13)
    }
}
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm2sts::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm2sts::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm2stsSpec;
impl crate::RegisterSpec for Sm2stsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm2sts::R`](R) reader structure"]
impl crate::Readable for Sm2stsSpec {}
#[doc = "`write(|w| ..)` method takes [`sm2sts::W`](W) writer structure"]
impl crate::Writable for Sm2stsSpec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0x30ff;
}
#[doc = "`reset()` method sets SM2STS to value 0"]
impl crate::Resettable for Sm2stsSpec {}
