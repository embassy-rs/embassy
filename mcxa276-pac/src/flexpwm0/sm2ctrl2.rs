#[doc = "Register `SM2CTRL2` reader"]
pub type R = crate::R<Sm2ctrl2Spec>;
#[doc = "Register `SM2CTRL2` writer"]
pub type W = crate::W<Sm2ctrl2Spec>;
...
impl W {
    #[doc = "Bits 0:1 - Clock Source Select"]
    #[inline(always)]
    pub fn clk_sel(&mut self) -> ClkSelW<Sm2ctrl2Spec> {
        ClkSelW::new(self, 0)
    }
    #[doc = "Bit 2 - Reload Source Select"]
    #[inline(always)]
    pub fn reload_sel(&mut self) -> ReloadSelW<Sm2ctrl2Spec> {
        ReloadSelW::new(self, 2)
    }
    #[doc = "Bits 3:5 - Force Select"]
    #[inline(always)]
    pub fn force_sel(&mut self) -> ForceSelW<Sm2ctrl2Spec> {
        ForceSelW::new(self, 3)
    }
    #[doc = "Bit 6 - Force Initialization"]
    #[inline(always)]
    pub fn force(&mut self) -> ForceW<Sm2ctrl2Spec> {
        ForceW::new(self, 6)
    }
    #[doc = "Bit 7 - Force Enable"]
    #[inline(always)]
    pub fn frcen(&mut self) -> FrcenW<Sm2ctrl2Spec> {
        FrcenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Initialization Control Select"]
    #[inline(always)]
    pub fn init_sel(&mut self) -> InitSelW<Sm2ctrl2Spec> {
        InitSelW::new(self, 8)
    }
    #[doc = "Bit 10 - PWM_X Initial Value"]
    #[inline(always)]
    pub fn pwmx_init(&mut self) -> PwmxInitW<Sm2ctrl2Spec> {
        PwmxInitW::new(self, 10)
    }
    #[doc = "Bit 11 - PWM45 Initial Value"]
    #[inline(always)]
    pub fn pwm45_init(&mut self) -> Pwm45InitW<Sm2ctrl2Spec> {
        Pwm45InitW::new(self, 11)
    }
    #[doc = "Bit 12 - PWM23 Initial Value"]
    #[inline(always)]
    pub fn pwm23_init(&mut self) -> Pwm23InitW<Sm2ctrl2Spec> {
        Pwm23InitW::new(self, 12)
    }
    #[doc = "Bit 13 - Independent or Complementary Pair Operation"]
    #[inline(always)]
    pub fn indep(&mut self) -> IndepW<Sm2ctrl2Spec> {
        IndepW::new(self, 13)
    }
    #[doc = "Bit 15 - Debug Enable"]
    #[inline(always)]
    pub fn dbgen(&mut self) -> DbgenW<Sm2ctrl2Spec> {
        DbgenW::new(self, 15)
    }
}
...
pub struct Sm2ctrl2Spec;
impl crate::RegisterSpec for Sm2ctrl2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm2ctrl2::R`](R) reader structure"]
impl crate::Readable for Sm2ctrl2Spec {}
#[doc = "`write(|w| ..)` method takes [`sm2ctrl2::W`](W) writer structure"]
impl crate::Writable for Sm2ctrl2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM2CTRL2 to value 0"]
impl crate::Resettable for Sm2ctrl2Spec {}
