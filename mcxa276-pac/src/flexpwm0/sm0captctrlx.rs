#[doc = "Register `SM0CAPTCTRLX` reader"]
pub type R = crate::R<Sm0captctrlxSpec>;
#[doc = "Register `SM0CAPTCTRLX` writer"]
pub type W = crate::W<Sm0captctrlxSpec>;
#[doc = "Arm X\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bit 0 - Arm X"]
    #[inline(always)]
    pub fn armx(&mut self) -> ArmxW<Sm0captctrlxSpec> {
        ArmxW::new(self, 0)
    }
    #[doc = "Bit 1 - One Shot Mode Aux"]
    #[inline(always)]
    pub fn oneshotx(&mut self) -> OneshotxW<Sm0captctrlxSpec> {
        OneshotxW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Edge X 0"]
    #[inline(always)]
    pub fn edgx0(&mut self) -> Edgx0W<Sm0captctrlxSpec> {
        Edgx0W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Edge X 1"]
    #[inline(always)]
    pub fn edgx1(&mut self) -> Edgx1W<Sm0captctrlxSpec> {
        Edgx1W::new(self, 4)
    }
    #[doc = "Bit 6 - Input Select X"]
    #[inline(always)]
    pub fn inp_selx(&mut self) -> InpSelxW<Sm0captctrlxSpec> {
        InpSelxW::new(self, 6)
    }
    #[doc = "Bit 7 - Edge Counter X Enable"]
    #[inline(always)]
    pub fn edgcntx_en(&mut self) -> EdgcntxEnW<Sm0captctrlxSpec> {
        EdgcntxEnW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Capture X FIFOs Water Mark"]
    #[inline(always)]
    pub fn cfxwm(&mut self) -> CfxwmW<Sm0captctrlxSpec> {
        CfxwmW::new(self, 8)
    }
}
...
pub struct Sm0captctrlxSpec;
impl crate::RegisterSpec for Sm0captctrlxSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm0captctrlx::R`](R) reader structure"]
impl crate::Readable for Sm0captctrlxSpec {}
#[doc = "`write(|w| ..)` method takes [`sm0captctrlx::W`](W) writer structure"]
impl crate::Writable for Sm0captctrlxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM0CAPTCTRLX to value 0"]
impl crate::Resettable for Sm0captctrlxSpec {}
