#[doc = "Register `SM3TCTRL` reader"]
pub type R = crate::R<Sm3tctrlSpec>;
#[doc = "Register `SM3TCTRL` writer"]
pub type W = crate::W<Sm3tctrlSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Output Trigger Enables"]
    #[inline(always)]
    pub fn out_trig_en(&mut self) -> OutTrigEnW<Sm3tctrlSpec> {
        OutTrigEnW::new(self, 0)
    }
    #[doc = "Bit 12 - Trigger Frequency"]
    #[inline(always)]
    pub fn trgfrq(&mut self) -> TrgfrqW<Sm3tctrlSpec> {
        TrgfrqW::new(self, 12)
    }
    #[doc = "Bit 14 - Mux Output Trigger 1 Source Select"]
    #[inline(always)]
    pub fn pwbot1(&mut self) -> Pwbot1W<Sm3tctrlSpec> {
        Pwbot1W::new(self, 14)
    }
    #[doc = "Bit 15 - Mux Output Trigger 0 Source Select"]
    #[inline(always)]
    pub fn pwaot0(&mut self) -> Pwaot0W<Sm3tctrlSpec> {
        Pwaot0W::new(self, 15)
    }
}
#[doc = "Output Trigger Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm3tctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm3tctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm3tctrlSpec;
impl crate::RegisterSpec for Sm3tctrlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm3tctrl::R`](R) reader structure"]
impl crate::Readable for Sm3tctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sm3tctrl::W`](W) writer structure"]
impl crate::Writable for Sm3tctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM3TCTRL to value 0"]
impl crate::Resettable for Sm3tctrlSpec {}
