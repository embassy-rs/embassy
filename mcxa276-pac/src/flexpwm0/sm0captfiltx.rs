#[doc = "Register `SM0CAPTFILTX` reader"]
pub type R = crate::R<Sm0captfiltxSpec>;
#[doc = "Register `SM0CAPTFILTX` writer"]
pub type W = crate::W<Sm0captfiltxSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Input Capture Filter Period"]
    #[inline(always)]
    pub fn captx_filt_per(&mut self) -> CaptxFiltPerW<Sm0captfiltxSpec> {
        CaptxFiltPerW::new(self, 0)
    }
    #[doc = "Bits 8:10 - Input Capture Filter Count"]
    #[inline(always)]
    pub fn captx_filt_cnt(&mut self) -> CaptxFiltCntW<Sm0captfiltxSpec> {
...
pub struct Sm0captfiltxSpec;
impl crate::RegisterSpec for Sm0captfiltxSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm0captfiltx::R`](R) reader structure"]
impl crate::Readable for Sm0captfiltxSpec {}
#[doc = "`write(|w| ..)` method takes [`sm0captfiltx::W`](W) writer structure"]
impl crate::Writable for Sm0captfiltxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM0CAPTFILTX to value 0"]
impl crate::Resettable for Sm0captfiltxSpec {}
