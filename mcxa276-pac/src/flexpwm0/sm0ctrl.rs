#[doc = "Register `SM0CTRL` reader"]
pub type R = crate::R<Sm0ctrlSpec>;
#[doc = "Register `SM0CTRL` writer"]
pub type W = crate::W<Sm0ctrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Double Switching Enable"]
    #[inline(always)]
    pub fn dblen(&mut self) -> DblenW<Sm0ctrlSpec> {
        DblenW::new(self, 0)
    }
    #[doc = "Bit 1 - PWM_X Double Switching Enable"]
    #[inline(always)]
    pub fn dblx(&mut self) -> DblxW<Sm0ctrlSpec> {
        DblxW::new(self, 1)
    }
    #[doc = "Bit 2 - Load Mode Select"]
    #[inline(always)]
    pub fn ldmod(&mut self) -> LdmodW<Sm0ctrlSpec> {
        LdmodW::new(self, 2)
    }
    #[doc = "Bit 3 - Split the DBLPWM signal to PWM_A and PWM_B"]
    #[inline(always)]
    pub fn split(&mut self) -> SplitW<Sm0ctrlSpec> {
        SplitW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Prescaler"]
    #[inline(always)]
    pub fn prsc(&mut self) -> PrscW<Sm0ctrlSpec> {
        PrscW::new(self, 4)
    }
    #[doc = "Bit 7 - Compare Mode"]
    #[inline(always)]
    pub fn compmode(&mut self) -> CompmodeW<Sm0ctrlSpec> {
        CompmodeW::new(self, 7)
    }
    #[doc = "Bit 10 - Full Cycle Reload"]
    #[inline(always)]
    pub fn full(&mut self) -> FullW<Sm0ctrlSpec> {
        FullW::new(self, 10)
    }
    #[doc = "Bit 11 - Half Cycle Reload"]
    #[inline(always)]
    pub fn half(&mut self) -> HalfW<Sm0ctrlSpec> {
        HalfW::new(self, 11)
    }
    #[doc = "Bits 12:15 - Load Frequency"]
    #[inline(always)]
    pub fn ldfq(&mut self) -> LdfqW<Sm0ctrlSpec> {
        LdfqW::new(self, 12)
    }
}
...
pub struct Sm0ctrlSpec;
impl crate::RegisterSpec for Sm0ctrlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm0ctrl::R`](R) reader structure"]
impl crate::Readable for Sm0ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sm0ctrl::W`](W) writer structure"]
impl crate::Writable for Sm0ctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM0CTRL to value 0x0400"]
impl crate::Resettable for Sm0ctrlSpec {
