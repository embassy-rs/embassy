#[doc = "Register `SM2DMAEN` reader"]
pub type R = crate::R<Sm2dmaenSpec>;
#[doc = "Register `SM2DMAEN` writer"]
pub type W = crate::W<Sm2dmaenSpec>;
...
impl W {
    #[doc = "Bit 0 - Capture X0 FIFO DMA Enable"]
    #[inline(always)]
    pub fn cx0de(&mut self) -> Cx0deW<Sm2dmaenSpec> {
        Cx0deW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture X1 FIFO DMA Enable"]
    #[inline(always)]
    pub fn cx1de(&mut self) -> Cx1deW<Sm2dmaenSpec> {
        Cx1deW::new(self, 1)
    }
    #[doc = "Bits 6:7 - Capture DMA Enable Source Select"]
    #[inline(always)]
    pub fn captde(&mut self) -> CaptdeW<Sm2dmaenSpec> {
        CaptdeW::new(self, 6)
    }
    #[doc = "Bit 8 - FIFO Watermark AND Control"]
    #[inline(always)]
    pub fn fand(&mut self) -> FandW<Sm2dmaenSpec> {
        FandW::new(self, 8)
    }
    #[doc = "Bit 9 - Value Registers DMA Enable"]
    #[inline(always)]
    pub fn valde(&mut self) -> ValdeW<Sm2dmaenSpec> {
        ValdeW::new(self, 9)
    }
}
#[doc = "DMA Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm2dmaen::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm2dmaen::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm2dmaenSpec;
impl crate::RegisterSpec for Sm2dmaenSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm2dmaen::R`](R) reader structure"]
impl crate::Readable for Sm2dmaenSpec {}
#[doc = "`write(|w| ..)` method takes [`sm2dmaen::W`](W) writer structure"]
impl crate::Writable for Sm2dmaenSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM2DMAEN to value 0"]
impl crate::Resettable for Sm2dmaenSpec {}
