#[doc = "Register `SM0OCTRL` reader"]
pub type R = crate::R<Sm0octrlSpec>;
#[doc = "Register `SM0OCTRL` writer"]
pub type W = crate::W<Sm0octrlSpec>;
...
impl W {
    #[doc = "Bits 0:1 - PWM_X Fault State"]
    #[inline(always)]
    pub fn pwmxfs(&mut self) -> PwmxfsW<Sm0octrlSpec> {
        PwmxfsW::new(self, 0)
    }
    #[doc = "Bits 2:3 - PWM_B Fault State"]
    #[inline(always)]
    pub fn pwmbfs(&mut self) -> PwmbfsW<Sm0octrlSpec> {
        PwmbfsW::new(self, 2)
    }
    #[doc = "Bits 4:5 - PWM_A Fault State"]
    #[inline(always)]
    pub fn pwmafs(&mut self) -> PwmafsW<Sm0octrlSpec> {
        PwmafsW::new(self, 4)
    }
    #[doc = "Bit 8 - PWM_X Output Polarity"]
    #[inline(always)]
    pub fn polx(&mut self) -> PolxW<Sm0octrlSpec> {
        PolxW::new(self, 8)
    }
    #[doc = "Bit 9 - PWM_B Output Polarity"]
    #[inline(always)]
    pub fn polb(&mut self) -> PolbW<Sm0octrlSpec> {
        PolbW::new(self, 9)
    }
    #[doc = "Bit 10 - PWM_A Output Polarity"]
    #[inline(always)]
    pub fn pola(&mut self) -> PolaW<Sm0octrlSpec> {
        PolaW::new(self, 10)
    }
}
...
pub struct Sm0octrlSpec;
impl crate::RegisterSpec for Sm0octrlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm0octrl::R`](R) reader structure"]
impl crate::Readable for Sm0octrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sm0octrl::W`](W) writer structure"]
impl crate::Writable for Sm0octrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM0OCTRL to value 0"]
impl crate::Resettable for Sm0octrlSpec {}
