#[doc = "Register `SM1CAPTCOMPX` reader"]
pub type R = crate::R<Sm1captcompxSpec>;
#[doc = "Register `SM1CAPTCOMPX` writer"]
pub type W = crate::W<Sm1captcompxSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Edge Compare X"]
    #[inline(always)]
    pub fn edgcmpx(&mut self) -> EdgcmpxW<Sm1captcompxSpec> {
        EdgcmpxW::new(self, 0)
    }
}
...
pub struct Sm1captcompxSpec;
impl crate::RegisterSpec for Sm1captcompxSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm1captcompx::R`](R) reader structure"]
impl crate::Readable for Sm1captcompxSpec {}
#[doc = "`write(|w| ..)` method takes [`sm1captcompx::W`](W) writer structure"]
impl crate::Writable for Sm1captcompxSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM1CAPTCOMPX to value 0"]
impl crate::Resettable for Sm1captcompxSpec {}
