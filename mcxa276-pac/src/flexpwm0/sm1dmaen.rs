#[doc = "Register `SM1DMAEN` reader"]
pub type R = crate::R<Sm1dmaenSpec>;
#[doc = "Register `SM1DMAEN` writer"]
pub type W = crate::W<Sm1dmaenSpec>;
...
impl W {
    #[doc = "Bit 0 - Capture X0 FIFO DMA Enable"]
    #[inline(always)]
    pub fn cx0de(&mut self) -> Cx0deW<Sm1dmaenSpec> {
        Cx0deW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture X1 FIFO DMA Enable"]
    #[inline(always)]
    pub fn cx1de(&mut self) -> Cx1deW<Sm1dmaenSpec> {
        Cx1deW::new(self, 1)
    }
    #[doc = "Bits 6:7 - Capture DMA Enable Source Select"]
    #[inline(always)]
    pub fn captde(&mut self) -> CaptdeW<Sm1dmaenSpec> {
        CaptdeW::new(self, 6)
    }
    #[doc = "Bit 8 - FIFO Watermark AND Control"]
    #[inline(always)]
    pub fn fand(&mut self) -> FandW<Sm1dmaenSpec> {
        FandW::new(self, 8)
    }
    #[doc = "Bit 9 - Value Registers DMA Enable"]
    #[inline(always)]
    pub fn valde(&mut self) -> ValdeW<Sm1dmaenSpec> {
        ValdeW::new(self, 9)
    }
}
...
pub struct Sm1dmaenSpec;
impl crate::RegisterSpec for Sm1dmaenSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm1dmaen::R`](R) reader structure"]
impl crate::Readable for Sm1dmaenSpec {}
#[doc = "`write(|w| ..)` method takes [`sm1dmaen::W`](W) writer structure"]
impl crate::Writable for Sm1dmaenSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM1DMAEN to value 0"]
impl crate::Resettable for Sm1dmaenSpec {}
