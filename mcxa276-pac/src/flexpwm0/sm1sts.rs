#[doc = "Register `SM1STS` reader"]
pub type R = crate::R<Sm1stsSpec>;
#[doc = "Register `SM1STS` writer"]
pub type W = crate::W<Sm1stsSpec>;
#[doc = "Compare Flags\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:5 - Compare Flags"]
    #[inline(always)]
    pub fn cmpf(&mut self) -> CmpfW<Sm1stsSpec> {
        CmpfW::new(self, 0)
    }
    #[doc = "Bit 6 - Capture Flag X0"]
    #[inline(always)]
    pub fn cfx0(&mut self) -> Cfx0W<Sm1stsSpec> {
        Cfx0W::new(self, 6)
    }
    #[doc = "Bit 7 - Capture Flag X1"]
    #[inline(always)]
    pub fn cfx1(&mut self) -> Cfx1W<Sm1stsSpec> {
        Cfx1W::new(self, 7)
    }
    #[doc = "Bit 12 - Reload Flag"]
    #[inline(always)]
    pub fn rf(&mut self) -> RfW<Sm1stsSpec> {
        RfW::new(self, 12)
    }
    #[doc = "Bit 13 - Reload Error Flag"]
    #[inline(always)]
    pub fn ref_(&mut self) -> RefW<Sm1stsSpec> {
        RefW::new(self, 13)
    }
}
#[doc = "Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm1sts::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm1sts::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm1stsSpec;
impl crate::RegisterSpec for Sm1stsSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm1sts::R`](R) reader structure"]
impl crate::Readable for Sm1stsSpec {}
#[doc = "`write(|w| ..)` method takes [`sm1sts::W`](W) writer structure"]
impl crate::Writable for Sm1stsSpec {
    type Safety = crate::Unsafe;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0x30ff;
}
#[doc = "`reset()` method sets SM1STS to value 0"]
impl crate::Resettable for Sm1stsSpec {}
