#[doc = "Register `SM0DMAEN` reader"]
pub type R = crate::R<Sm0dmaenSpec>;
#[doc = "Register `SM0DMAEN` writer"]
pub type W = crate::W<Sm0dmaenSpec>;
...
impl W {
    #[doc = "Bit 0 - Capture X0 FIFO DMA Enable"]
    #[inline(always)]
    pub fn cx0de(&mut self) -> Cx0deW<Sm0dmaenSpec> {
        Cx0deW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture X1 FIFO DMA Enable"]
    #[inline(always)]
    pub fn cx1de(&mut self) -> Cx1deW<Sm0dmaenSpec> {
        Cx1deW::new(self, 1)
    }
    #[doc = "Bits 6:7 - Capture DMA Enable Source Select"]
    #[inline(always)]
    pub fn captde(&mut self) -> CaptdeW<Sm0dmaenSpec> {
        CaptdeW::new(self, 6)
    }
    #[doc = "Bit 8 - FIFO Watermark AND Control"]
    #[inline(always)]
    pub fn fand(&mut self) -> FandW<Sm0dmaenSpec> {
        FandW::new(self, 8)
    }
    #[doc = "Bit 9 - Value Registers DMA Enable"]
    #[inline(always)]
    pub fn valde(&mut self) -> ValdeW<Sm0dmaenSpec> {
        ValdeW::new(self, 9)
    }
}
#[doc = "DMA Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm0dmaen::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm0dmaen::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm0dmaenSpec;
impl crate::RegisterSpec for Sm0dmaenSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm0dmaen::R`](R) reader structure"]
impl crate::Readable for Sm0dmaenSpec {}
#[doc = "`write(|w| ..)` method takes [`sm0dmaen::W`](W) writer structure"]
impl crate::Writable for Sm0dmaenSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM0DMAEN to value 0"]
impl crate::Resettable for Sm0dmaenSpec {}
