#[doc = "Register `SM1OCTRL` reader"]
pub type R = crate::R<Sm1octrlSpec>;
#[doc = "Register `SM1OCTRL` writer"]
pub type W = crate::W<Sm1octrlSpec>;
...
impl W {
    #[doc = "Bits 0:1 - PWM_X Fault State"]
    #[inline(always)]
    pub fn pwmxfs(&mut self) -> PwmxfsW<Sm1octrlSpec> {
        PwmxfsW::new(self, 0)
    }
    #[doc = "Bits 2:3 - PWM_B Fault State"]
    #[inline(always)]
    pub fn pwmbfs(&mut self) -> PwmbfsW<Sm1octrlSpec> {
        PwmbfsW::new(self, 2)
    }
    #[doc = "Bits 4:5 - PWM_A Fault State"]
    #[inline(always)]
    pub fn pwmafs(&mut self) -> PwmafsW<Sm1octrlSpec> {
        PwmafsW::new(self, 4)
    }
    #[doc = "Bit 8 - PWM_X Output Polarity"]
    #[inline(always)]
    pub fn polx(&mut self) -> PolxW<Sm1octrlSpec> {
        PolxW::new(self, 8)
    }
    #[doc = "Bit 9 - PWM_B Output Polarity"]
    #[inline(always)]
    pub fn polb(&mut self) -> PolbW<Sm1octrlSpec> {
        PolbW::new(self, 9)
    }
    #[doc = "Bit 10 - PWM_A Output Polarity"]
    #[inline(always)]
    pub fn pola(&mut self) -> PolaW<Sm1octrlSpec> {
        PolaW::new(self, 10)
    }
}
#[doc = "Output Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sm1octrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm1octrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sm1octrlSpec;
impl crate::RegisterSpec for Sm1octrlSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm1octrl::R`](R) reader structure"]
impl crate::Readable for Sm1octrlSpec {}
#[doc = "`write(|w| ..)` method takes [`sm1octrl::W`](W) writer structure"]
impl crate::Writable for Sm1octrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM1OCTRL to value 0"]
impl crate::Resettable for Sm1octrlSpec {}
