#[doc = "Register `SM3INTEN` reader"]
pub type R = crate::R<Sm3intenSpec>;
#[doc = "Register `SM3INTEN` writer"]
pub type W = crate::W<Sm3intenSpec>;
...
impl W {
    #[doc = "Bits 0:5 - Compare Interrupt Enables"]
    #[inline(always)]
    pub fn cmpie(&mut self) -> CmpieW<Sm3intenSpec> {
        CmpieW::new(self, 0)
    }
    #[doc = "Bit 6 - Capture X 0 Interrupt Enable"]
    #[inline(always)]
    pub fn cx0ie(&mut self) -> Cx0ieW<Sm3intenSpec> {
        Cx0ieW::new(self, 6)
    }
    #[doc = "Bit 7 - Capture X 1 Interrupt Enable"]
    #[inline(always)]
    pub fn cx1ie(&mut self) -> Cx1ieW<Sm3intenSpec> {
        Cx1ieW::new(self, 7)
    }
    #[doc = "Bit 12 - Reload Interrupt Enable"]
    #[inline(always)]
    pub fn rie(&mut self) -> RieW<Sm3intenSpec> {
        RieW::new(self, 12)
    }
    #[doc = "Bit 13 - Reload Error Interrupt Enable"]
    #[inline(always)]
    pub fn reie(&mut self) -> ReieW<Sm3intenSpec> {
        ReieW::new(self, 13)
    }
}
...
pub struct Sm3intenSpec;
impl crate::RegisterSpec for Sm3intenSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sm3inten::R`](R) reader structure"]
impl crate::Readable for Sm3intenSpec {}
#[doc = "`write(|w| ..)` method takes [`sm3inten::W`](W) writer structure"]
impl crate::Writable for Sm3intenSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SM3INTEN to value 0"]
impl crate::Resettable for Sm3intenSpec {}
