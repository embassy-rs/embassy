#[doc = "Register `MRCC_I3C0_FCLK_CLKSEL` reader"]
pub type R = crate::R<MrccI3c0FclkClkselSpec>;
#[doc = "Register `MRCC_I3C0_FCLK_CLKSEL` writer"]
pub type W = crate::W<MrccI3c0FclkClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccI3c0FclkClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccI3c0FclkClkselSpec;
impl crate::RegisterSpec for MrccI3c0FclkClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_i3c0_fclk_clksel::R`](R) reader structure"]
impl crate::Readable for MrccI3c0FclkClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_i3c0_fclk_clksel::W`](W) writer structure"]
impl crate::Writable for MrccI3c0FclkClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_I3C0_FCLK_CLKSEL to value 0x07"]
impl crate::Resettable for MrccI3c0FclkClkselSpec {
