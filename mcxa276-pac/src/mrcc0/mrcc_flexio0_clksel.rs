#[doc = "Register `MRCC_FLEXIO0_CLKSEL` reader"]
pub type R = crate::R<MrccFlexio0ClkselSpec>;
#[doc = "Register `MRCC_FLEXIO0_CLKSEL` writer"]
pub type W = crate::W<MrccFlexio0ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccFlexio0ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccFlexio0ClkselSpec;
impl crate::RegisterSpec for MrccFlexio0ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_flexio0_clksel::R`](R) reader structure"]
impl crate::Readable for MrccFlexio0ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_flexio0_clksel::W`](W) writer structure"]
impl crate::Writable for MrccFlexio0ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_FLEXIO0_CLKSEL to value 0x07"]
impl crate::Resettable for MrccFlexio0ClkselSpec {
