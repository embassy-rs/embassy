#[doc = "Register `MRCC_LPI2C1_CLKDIV` reader"]
pub type R = crate::R<MrccLpi2c1ClkdivSpec>;
#[doc = "Register `MRCC_LPI2C1_CLKDIV` writer"]
pub type W = crate::W<MrccLpi2c1ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpi2c1ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpi2c1ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpi2c1ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpi2c1ClkdivSpec;
impl crate::RegisterSpec for MrccLpi2c1ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpi2c1_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpi2c1ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpi2c1_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpi2c1ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPI2C1_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpi2c1ClkdivSpec {
