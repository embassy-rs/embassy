#[doc = "Register `MRCC_LPSPI1_CLKSEL` reader"]
pub type R = crate::R<MrccLpspi1ClkselSpec>;
#[doc = "Register `MRCC_LPSPI1_CLKSEL` writer"]
pub type W = crate::W<MrccLpspi1ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpspi1ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpspi1ClkselSpec;
impl crate::RegisterSpec for MrccLpspi1ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpspi1_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpspi1ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpspi1_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpspi1ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPSPI1_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpspi1ClkselSpec {
