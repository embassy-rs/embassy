#[doc = "Register `MRCC_CTIMER0_CLKSEL` reader"]
pub type R = crate::R<MrccCtimer0ClkselSpec>;
#[doc = "Register `MRCC_CTIMER0_CLKSEL` writer"]
pub type W = crate::W<MrccCtimer0ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccCtimer0ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccCtimer0ClkselSpec;
impl crate::RegisterSpec for MrccCtimer0ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_ctimer0_clksel::R`](R) reader structure"]
impl crate::Readable for MrccCtimer0ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_ctimer0_clksel::W`](W) writer structure"]
impl crate::Writable for MrccCtimer0ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CTIMER0_CLKSEL to value 0x07"]
impl crate::Resettable for MrccCtimer0ClkselSpec {
