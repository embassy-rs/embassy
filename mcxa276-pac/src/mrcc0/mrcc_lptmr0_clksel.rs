#[doc = "Register `MRCC_LPTMR0_CLKSEL` reader"]
pub type R = crate::R<MrccLptmr0ClkselSpec>;
#[doc = "Register `MRCC_LPTMR0_CLKSEL` writer"]
pub type W = crate::W<MrccLptmr0ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLptmr0ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLptmr0ClkselSpec;
impl crate::RegisterSpec for MrccLptmr0ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lptmr0_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLptmr0ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lptmr0_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLptmr0ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPTMR0_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLptmr0ClkselSpec {
