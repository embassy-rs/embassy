#[doc = "Register `MRCC_LPUART2_CLKDIV` reader"]
pub type R = crate::R<MrccLpuart2ClkdivSpec>;
#[doc = "Register `MRCC_LPUART2_CLKDIV` writer"]
pub type W = crate::W<MrccLpuart2ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpuart2ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpuart2ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpuart2ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpuart2ClkdivSpec;
impl crate::RegisterSpec for MrccLpuart2ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart2_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpuart2ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart2_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpuart2ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART2_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpuart2ClkdivSpec {
