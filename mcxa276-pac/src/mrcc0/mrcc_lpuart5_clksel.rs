#[doc = "Register `MRCC_LPUART5_CLKSEL` reader"]
pub type R = crate::R<MrccLpuart5ClkselSpec>;
#[doc = "Register `MRCC_LPUART5_CLKSEL` writer"]
pub type W = crate::W<MrccLpuart5ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpuart5ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpuart5ClkselSpec;
impl crate::RegisterSpec for MrccLpuart5ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart5_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpuart5ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart5_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpuart5ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART5_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpuart5ClkselSpec {
