#[doc = "Register `MRCC_LPSPI0_CLKSEL` reader"]
pub type R = crate::R<MrccLpspi0ClkselSpec>;
#[doc = "Register `MRCC_LPSPI0_CLKSEL` writer"]
pub type W = crate::W<MrccLpspi0ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpspi0ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpspi0ClkselSpec;
impl crate::RegisterSpec for MrccLpspi0ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpspi0_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpspi0ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpspi0_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpspi0ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPSPI0_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpspi0ClkselSpec {
