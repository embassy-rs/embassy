#[doc = "Register `MRCC_CMP2_RR_CLKSEL` reader"]
pub type R = crate::R<MrccCmp2RrClkselSpec>;
#[doc = "Register `MRCC_CMP2_RR_CLKSEL` writer"]
pub type W = crate::W<MrccCmp2RrClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccCmp2RrClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccCmp2RrClkselSpec;
impl crate::RegisterSpec for MrccCmp2RrClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_cmp2_rr_clksel::R`](R) reader structure"]
impl crate::Readable for MrccCmp2RrClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_cmp2_rr_clksel::W`](W) writer structure"]
impl crate::Writable for MrccCmp2RrClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CMP2_RR_CLKSEL to value 0x07"]
impl crate::Resettable for MrccCmp2RrClkselSpec {
