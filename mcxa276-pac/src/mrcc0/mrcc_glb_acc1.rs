...
impl W {
    #[doc = "Bit 0 - FLEXPWM1"]
    #[inline(always)]
    pub fn flexpwm1(&mut self) -> Flexpwm1W<MrccGlbAcc1Spec> {
        Flexpwm1W::new(self, 0)
    }
    #[doc = "Bit 1 - OSTIMER0"]
    #[inline(always)]
    pub fn ostimer0(&mut self) -> Ostimer0W<MrccGlbAcc1Spec> {
        Ostimer0W::new(self, 1)
    }
    #[doc = "Bit 2 - ADC0"]
    #[inline(always)]
    pub fn adc0(&mut self) -> Adc0W<MrccGlbAcc1Spec> {
        Adc0W::new(self, 2)
    }
    #[doc = "Bit 3 - ADC1"]
    #[inline(always)]
    pub fn adc1(&mut self) -> Adc1W<MrccGlbAcc1Spec> {
        Adc1W::new(self, 3)
    }
    #[doc = "Bit 4 - CMP0"]
    #[inline(always)]
    pub fn cmp0(&mut self) -> Cmp0W<MrccGlbAcc1Spec> {
        Cmp0W::new(self, 4)
    }
    #[doc = "Bit 5 - CMP1"]
    #[inline(always)]
    pub fn cmp1(&mut self) -> Cmp1W<MrccGlbAcc1Spec> {
        Cmp1W::new(self, 5)
    }
    #[doc = "Bit 6 - CMP2"]
    #[inline(always)]
    pub fn cmp2(&mut self) -> Cmp2W<MrccGlbAcc1Spec> {
        Cmp2W::new(self, 6)
    }
    #[doc = "Bit 7 - DAC0"]
    #[inline(always)]
    pub fn dac0(&mut self) -> Dac0W<MrccGlbAcc1Spec> {
        Dac0W::new(self, 7)
    }
    #[doc = "Bit 8 - OPAMP0"]
    #[inline(always)]
    pub fn opamp0(&mut self) -> Opamp0W<MrccGlbAcc1Spec> {
        Opamp0W::new(self, 8)
    }
    #[doc = "Bit 9 - OPAMP1"]
    #[inline(always)]
    pub fn opamp1(&mut self) -> Opamp1W<MrccGlbAcc1Spec> {
        Opamp1W::new(self, 9)
    }
    #[doc = "Bit 10 - OPAMP2"]
    #[inline(always)]
    pub fn opamp2(&mut self) -> Opamp2W<MrccGlbAcc1Spec> {
        Opamp2W::new(self, 10)
    }
    #[doc = "Bit 11 - OPAMP3"]
    #[inline(always)]
    pub fn opamp3(&mut self) -> Opamp3W<MrccGlbAcc1Spec> {
        Opamp3W::new(self, 11)
    }
    #[doc = "Bit 12 - PORT0"]
    #[inline(always)]
    pub fn port0(&mut self) -> Port0W<MrccGlbAcc1Spec> {
        Port0W::new(self, 12)
    }
    #[doc = "Bit 13 - PORT1"]
    #[inline(always)]
    pub fn port1(&mut self) -> Port1W<MrccGlbAcc1Spec> {
        Port1W::new(self, 13)
    }
    #[doc = "Bit 14 - PORT2"]
    #[inline(always)]
    pub fn port2(&mut self) -> Port2W<MrccGlbAcc1Spec> {
        Port2W::new(self, 14)
    }
    #[doc = "Bit 15 - PORT3"]
    #[inline(always)]
    pub fn port3(&mut self) -> Port3W<MrccGlbAcc1Spec> {
        Port3W::new(self, 15)
    }
    #[doc = "Bit 16 - PORT4"]
    #[inline(always)]
    pub fn port4(&mut self) -> Port4W<MrccGlbAcc1Spec> {
        Port4W::new(self, 16)
    }
    #[doc = "Bit 17 - SLCD0"]
    #[inline(always)]
    pub fn slcd0(&mut self) -> Slcd0W<MrccGlbAcc1Spec> {
        Slcd0W::new(self, 17)
    }
    #[doc = "Bit 18 - FLEXCAN0"]
    #[inline(always)]
    pub fn flexcan0(&mut self) -> Flexcan0W<MrccGlbAcc1Spec> {
        Flexcan0W::new(self, 18)
    }
    #[doc = "Bit 19 - FLEXCAN1"]
    #[inline(always)]
    pub fn flexcan1(&mut self) -> Flexcan1W<MrccGlbAcc1Spec> {
        Flexcan1W::new(self, 19)
    }
    #[doc = "Bit 20 - LPI2C2"]
    #[inline(always)]
    pub fn lpi2c2(&mut self) -> Lpi2c2W<MrccGlbAcc1Spec> {
        Lpi2c2W::new(self, 20)
    }
    #[doc = "Bit 21 - LPI2C3"]
    #[inline(always)]
    pub fn lpi2c3(&mut self) -> Lpi2c3W<MrccGlbAcc1Spec> {
        Lpi2c3W::new(self, 21)
    }
    #[doc = "Bit 22 - LPUART5"]
    #[inline(always)]
    pub fn lpuart5(&mut self) -> Lpuart5W<MrccGlbAcc1Spec> {
        Lpuart5W::new(self, 22)
    }
    #[doc = "Bit 24 - PKC0"]
    #[inline(always)]
    pub fn pkc0(&mut self) -> Pkc0W<MrccGlbAcc1Spec> {
        Pkc0W::new(self, 24)
    }
    #[doc = "Bit 25 - SGI0"]
    #[inline(always)]
    pub fn sgi0(&mut self) -> Sgi0W<MrccGlbAcc1Spec> {
        Sgi0W::new(self, 25)
    }
    #[doc = "Bit 26 - TRNG0"]
    #[inline(always)]
    pub fn trng0(&mut self) -> Trng0W<MrccGlbAcc1Spec> {
        Trng0W::new(self, 26)
    }
    #[doc = "Bit 27 - UDF0"]
    #[inline(always)]
    pub fn udf0(&mut self) -> Udf0W<MrccGlbAcc1Spec> {
        Udf0W::new(self, 27)
    }
    #[doc = "Bit 28 - ADC2"]
    #[inline(always)]
    pub fn adc2(&mut self) -> Adc2W<MrccGlbAcc1Spec> {
        Adc2W::new(self, 28)
    }
    #[doc = "Bit 29 - ADC3"]
    #[inline(always)]
    pub fn adc3(&mut self) -> Adc3W<MrccGlbAcc1Spec> {
        Adc3W::new(self, 29)
    }
}
...
#[doc = "`reset()` method sets MRCC_GLB_ACC1 to value 0"]
