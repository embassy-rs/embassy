#[doc = "Register `MRCC_DAC0_CLKSEL` reader"]
pub type R = crate::R<MrccDac0ClkselSpec>;
#[doc = "Register `MRCC_DAC0_CLKSEL` writer"]
pub type W = crate::W<MrccDac0ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccDac0ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccDac0ClkselSpec;
impl crate::RegisterSpec for MrccDac0ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_dac0_clksel::R`](R) reader structure"]
impl crate::Readable for MrccDac0ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_dac0_clksel::W`](W) writer structure"]
impl crate::Writable for MrccDac0ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_DAC0_CLKSEL to value 0x07"]
impl crate::Resettable for MrccDac0ClkselSpec {
