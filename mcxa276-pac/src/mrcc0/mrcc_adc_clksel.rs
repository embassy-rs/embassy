#[doc = "Register `MRCC_ADC_CLKSEL` reader"]
pub type R = crate::R<MrccAdcClkselSpec>;
#[doc = "Register `MRCC_ADC_CLKSEL` writer"]
pub type W = crate::W<MrccAdcClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccAdcClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccAdcClkselSpec;
impl crate::RegisterSpec for MrccAdcClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_adc_clksel::R`](R) reader structure"]
impl crate::Readable for MrccAdcClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_adc_clksel::W`](W) writer structure"]
impl crate::Writable for MrccAdcClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_ADC_CLKSEL to value 0x07"]
impl crate::Resettable for MrccAdcClkselSpec {
