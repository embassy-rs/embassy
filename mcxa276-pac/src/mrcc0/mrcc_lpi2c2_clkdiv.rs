#[doc = "Register `MRCC_LPI2C2_CLKDIV` reader"]
pub type R = crate::R<MrccLpi2c2ClkdivSpec>;
#[doc = "Register `MRCC_LPI2C2_CLKDIV` writer"]
pub type W = crate::W<MrccLpi2c2ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpi2c2ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpi2c2ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpi2c2ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpi2c2ClkdivSpec;
impl crate::RegisterSpec for MrccLpi2c2ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpi2c2_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpi2c2ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpi2c2_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpi2c2ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPI2C2_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpi2c2ClkdivSpec {
