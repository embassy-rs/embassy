#[doc = "Register `MRCC_LPUART0_CLKSEL` reader"]
pub type R = crate::R<MrccLpuart0ClkselSpec>;
#[doc = "Register `MRCC_LPUART0_CLKSEL` writer"]
pub type W = crate::W<MrccLpuart0ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpuart0ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpuart0ClkselSpec;
impl crate::RegisterSpec for MrccLpuart0ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart0_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpuart0ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart0_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpuart0ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART0_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpuart0ClkselSpec {
