#[doc = "Register `MRCC_LPUART3_CLKDIV` reader"]
pub type R = crate::R<MrccLpuart3ClkdivSpec>;
#[doc = "Register `MRCC_LPUART3_CLKDIV` writer"]
pub type W = crate::W<MrccLpuart3ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpuart3ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpuart3ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpuart3ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpuart3ClkdivSpec;
impl crate::RegisterSpec for MrccLpuart3ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart3_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpuart3ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart3_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpuart3ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART3_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpuart3ClkdivSpec {
