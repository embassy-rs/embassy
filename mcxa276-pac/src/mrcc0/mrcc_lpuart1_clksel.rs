#[doc = "Register `MRCC_LPUART1_CLKSEL` reader"]
pub type R = crate::R<MrccLpuart1ClkselSpec>;
#[doc = "Register `MRCC_LPUART1_CLKSEL` writer"]
pub type W = crate::W<MrccLpuart1ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpuart1ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpuart1ClkselSpec;
impl crate::RegisterSpec for MrccLpuart1ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart1_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpuart1ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart1_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpuart1ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART1_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpuart1ClkselSpec {
