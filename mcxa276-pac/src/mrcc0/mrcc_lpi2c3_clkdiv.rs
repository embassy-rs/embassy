#[doc = "Register `MRCC_LPI2C3_CLKDIV` reader"]
pub type R = crate::R<MrccLpi2c3ClkdivSpec>;
#[doc = "Register `MRCC_LPI2C3_CLKDIV` writer"]
pub type W = crate::W<MrccLpi2c3ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpi2c3ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpi2c3ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpi2c3ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpi2c3ClkdivSpec;
impl crate::RegisterSpec for MrccLpi2c3ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpi2c3_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpi2c3ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpi2c3_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpi2c3ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPI2C3_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpi2c3ClkdivSpec {
