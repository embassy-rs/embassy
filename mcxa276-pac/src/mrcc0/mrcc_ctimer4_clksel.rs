#[doc = "Register `MRCC_CTIMER4_CLKSEL` reader"]
pub type R = crate::R<MrccCtimer4ClkselSpec>;
#[doc = "Register `MRCC_CTIMER4_CLKSEL` writer"]
pub type W = crate::W<MrccCtimer4ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccCtimer4ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccCtimer4ClkselSpec;
impl crate::RegisterSpec for MrccCtimer4ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_ctimer4_clksel::R`](R) reader structure"]
impl crate::Readable for MrccCtimer4ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_ctimer4_clksel::W`](W) writer structure"]
impl crate::Writable for MrccCtimer4ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CTIMER4_CLKSEL to value 0x07"]
impl crate::Resettable for MrccCtimer4ClkselSpec {
