#[doc = "Register `MRCC_LPI2C2_CLKSEL` reader"]
pub type R = crate::R<MrccLpi2c2ClkselSpec>;
#[doc = "Register `MRCC_LPI2C2_CLKSEL` writer"]
pub type W = crate::W<MrccLpi2c2ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpi2c2ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpi2c2ClkselSpec;
impl crate::RegisterSpec for MrccLpi2c2ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpi2c2_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpi2c2ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpi2c2_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpi2c2ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPI2C2_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpi2c2ClkselSpec {
