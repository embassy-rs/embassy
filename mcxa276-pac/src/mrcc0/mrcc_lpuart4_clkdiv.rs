#[doc = "Register `MRCC_LPUART4_CLKDIV` reader"]
pub type R = crate::R<MrccLpuart4ClkdivSpec>;
#[doc = "Register `MRCC_LPUART4_CLKDIV` writer"]
pub type W = crate::W<MrccLpuart4ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpuart4ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpuart4ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpuart4ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpuart4ClkdivSpec;
impl crate::RegisterSpec for MrccLpuart4ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart4_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpuart4ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart4_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpuart4ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART4_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpuart4ClkdivSpec {
