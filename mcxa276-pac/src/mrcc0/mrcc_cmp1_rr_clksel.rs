#[doc = "Register `MRCC_CMP1_RR_CLKSEL` reader"]
pub type R = crate::R<MrccCmp1RrClkselSpec>;
#[doc = "Register `MRCC_CMP1_RR_CLKSEL` writer"]
pub type W = crate::W<MrccCmp1RrClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccCmp1RrClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccCmp1RrClkselSpec;
impl crate::RegisterSpec for MrccCmp1RrClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_cmp1_rr_clksel::R`](R) reader structure"]
impl crate::Readable for MrccCmp1RrClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_cmp1_rr_clksel::W`](W) writer structure"]
impl crate::Writable for MrccCmp1RrClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CMP1_RR_CLKSEL to value 0x07"]
impl crate::Resettable for MrccCmp1RrClkselSpec {
