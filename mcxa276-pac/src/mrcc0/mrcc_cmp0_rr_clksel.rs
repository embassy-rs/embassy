#[doc = "Register `MRCC_CMP0_RR_CLKSEL` reader"]
pub type R = crate::R<MrccCmp0RrClkselSpec>;
#[doc = "Register `MRCC_CMP0_RR_CLKSEL` writer"]
pub type W = crate::W<MrccCmp0RrClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccCmp0RrClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccCmp0RrClkselSpec;
impl crate::RegisterSpec for MrccCmp0RrClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_cmp0_rr_clksel::R`](R) reader structure"]
impl crate::Readable for MrccCmp0RrClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_cmp0_rr_clksel::W`](W) writer structure"]
impl crate::Writable for MrccCmp0RrClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CMP0_RR_CLKSEL to value 0x07"]
impl crate::Resettable for MrccCmp0RrClkselSpec {
