#[doc = "Register `MRCC_LPSPI1_CLKDIV` reader"]
pub type R = crate::R<MrccLpspi1ClkdivSpec>;
#[doc = "Register `MRCC_LPSPI1_CLKDIV` writer"]
pub type W = crate::W<MrccLpspi1ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpspi1ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpspi1ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpspi1ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpspi1ClkdivSpec;
impl crate::RegisterSpec for MrccLpspi1ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpspi1_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpspi1ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpspi1_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpspi1ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPSPI1_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpspi1ClkdivSpec {
