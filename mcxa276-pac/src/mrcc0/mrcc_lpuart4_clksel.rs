#[doc = "Register `MRCC_LPUART4_CLKSEL` reader"]
pub type R = crate::R<MrccLpuart4ClkselSpec>;
#[doc = "Register `MRCC_LPUART4_CLKSEL` writer"]
pub type W = crate::W<MrccLpuart4ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpuart4ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpuart4ClkselSpec;
impl crate::RegisterSpec for MrccLpuart4ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart4_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpuart4ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart4_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpuart4ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART4_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpuart4ClkselSpec {
