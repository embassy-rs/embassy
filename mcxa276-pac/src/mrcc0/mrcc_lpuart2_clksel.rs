#[doc = "Register `MRCC_LPUART2_CLKSEL` reader"]
pub type R = crate::R<MrccLpuart2ClkselSpec>;
#[doc = "Register `MRCC_LPUART2_CLKSEL` writer"]
pub type W = crate::W<MrccLpuart2ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpuart2ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpuart2ClkselSpec;
impl crate::RegisterSpec for MrccLpuart2ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart2_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpuart2ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart2_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpuart2ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART2_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpuart2ClkselSpec {
