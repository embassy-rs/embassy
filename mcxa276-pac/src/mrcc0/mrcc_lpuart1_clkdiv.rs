#[doc = "Register `MRCC_LPUART1_CLKDIV` reader"]
pub type R = crate::R<MrccLpuart1ClkdivSpec>;
#[doc = "Register `MRCC_LPUART1_CLKDIV` writer"]
pub type W = crate::W<MrccLpuart1ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpuart1ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpuart1ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpuart1ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpuart1ClkdivSpec;
impl crate::RegisterSpec for MrccLpuart1ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart1_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpuart1ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart1_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpuart1ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART1_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpuart1ClkdivSpec {
