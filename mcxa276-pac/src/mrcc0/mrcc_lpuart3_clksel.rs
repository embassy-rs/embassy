#[doc = "Register `MRCC_LPUART3_CLKSEL` reader"]
pub type R = crate::R<MrccLpuart3ClkselSpec>;
#[doc = "Register `MRCC_LPUART3_CLKSEL` writer"]
pub type W = crate::W<MrccLpuart3ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpuart3ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpuart3ClkselSpec;
impl crate::RegisterSpec for MrccLpuart3ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart3_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpuart3ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart3_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpuart3ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART3_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpuart3ClkselSpec {
