#[doc = "Register `MRCC_LPI2C1_CLKSEL` reader"]
pub type R = crate::R<MrccLpi2c1ClkselSpec>;
#[doc = "Register `MRCC_LPI2C1_CLKSEL` writer"]
pub type W = crate::W<MrccLpi2c1ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccLpi2c1ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccLpi2c1ClkselSpec;
impl crate::RegisterSpec for MrccLpi2c1ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpi2c1_clksel::R`](R) reader structure"]
impl crate::Readable for MrccLpi2c1ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpi2c1_clksel::W`](W) writer structure"]
impl crate::Writable for MrccLpi2c1ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPI2C1_CLKSEL to value 0x07"]
impl crate::Resettable for MrccLpi2c1ClkselSpec {
