#[doc = "Register `MRCC_CTIMER1_CLKSEL` reader"]
pub type R = crate::R<MrccCtimer1ClkselSpec>;
#[doc = "Register `MRCC_CTIMER1_CLKSEL` writer"]
pub type W = crate::W<MrccCtimer1ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccCtimer1ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccCtimer1ClkselSpec;
impl crate::RegisterSpec for MrccCtimer1ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_ctimer1_clksel::R`](R) reader structure"]
impl crate::Readable for MrccCtimer1ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_ctimer1_clksel::W`](W) writer structure"]
impl crate::Writable for MrccCtimer1ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CTIMER1_CLKSEL to value 0x07"]
impl crate::Resettable for MrccCtimer1ClkselSpec {
