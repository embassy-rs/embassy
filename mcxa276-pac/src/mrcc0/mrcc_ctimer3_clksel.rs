#[doc = "Register `MRCC_CTIMER3_CLKSEL` reader"]
pub type R = crate::R<MrccCtimer3ClkselSpec>;
#[doc = "Register `MRCC_CTIMER3_CLKSEL` writer"]
pub type W = crate::W<MrccCtimer3ClkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccCtimer3ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccCtimer3ClkselSpec;
impl crate::RegisterSpec for MrccCtimer3ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_ctimer3_clksel::R`](R) reader structure"]
impl crate::Readable for MrccCtimer3ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_ctimer3_clksel::W`](W) writer structure"]
impl crate::Writable for MrccCtimer3ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CTIMER3_CLKSEL to value 0x07"]
impl crate::Resettable for MrccCtimer3ClkselSpec {
