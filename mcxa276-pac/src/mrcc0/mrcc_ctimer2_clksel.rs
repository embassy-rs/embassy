#[doc = "Register `MRCC_CTIMER2_CLKSEL` reader"]
pub type R = crate::R<MrccCtimer2ClkselSpec>;
#[doc = "Register `MRCC_CTIMER2_CLKSEL` writer"]
pub type W = crate::W<MrccCtimer2ClkselSpec>;
...
impl MuxR {
    ...
    pub const fn variant(&self) -> Option<Mux> {
        match self.bits {
            ...
            1 => Some(Mux::ClkrootFunc1),
            3 => Some(Mux::ClkrootFunc3),
            4 => Some(Mux::ClkrootFunc4),
    ...
    #[doc = "FRO_HF_GATED"]
    #[inline(always)]
    pub fn is_clkroot_func_1(&self) -> bool {
        *self == Mux::ClkrootFunc1
    }
    #[doc = "CLK_IN"]
    #[inline(always)]
    ...
    #[doc = "CLK_16K"]
    #[inline(always)]
    pub fn is_clkroot_func_4(&self) -> bool {
        *self == Mux::ClkrootFunc4
    }
    #[doc = "CLK_1M"]
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "FRO_HF_GATED"]
    #[inline(always)]
    pub fn clkroot_func_1(self) -> &'a mut crate::W<REG> {
        self.variant(Mux::ClkrootFunc1)
    }
    #[doc = "CLK_IN"]
    #[inline(always)]
    ...
    #[doc = "CLK_16K"]
    #[inline(always)]
    pub fn clkroot_func_4(self) -> &'a mut crate::W<REG> {
        self.variant(Mux::ClkrootFunc4)
    }
    #[doc = "CLK_1M"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccCtimer2ClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccCtimer2ClkselSpec;
impl crate::RegisterSpec for MrccCtimer2ClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_ctimer2_clksel::R`](R) reader structure"]
impl crate::Readable for MrccCtimer2ClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_ctimer2_clksel::W`](W) writer structure"]
impl crate::Writable for MrccCtimer2ClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_CTIMER2_CLKSEL to value 0x07"]
impl crate::Resettable for MrccCtimer2ClkselSpec {
