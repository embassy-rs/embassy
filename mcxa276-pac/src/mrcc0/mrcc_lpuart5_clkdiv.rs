#[doc = "Register `MRCC_LPUART5_CLKDIV` reader"]
pub type R = crate::R<MrccLpuart5ClkdivSpec>;
#[doc = "Register `MRCC_LPUART5_CLKDIV` writer"]
pub type W = crate::W<MrccLpuart5ClkdivSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Functional Clock Divider"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MrccLpuart5ClkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Reset divider counter"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MrccLpuart5ClkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halt divider counter"]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MrccLpuart5ClkdivSpec> {
        HaltW::new(self, 30)
    }
}
...
pub struct MrccLpuart5ClkdivSpec;
impl crate::RegisterSpec for MrccLpuart5ClkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_lpuart5_clkdiv::R`](R) reader structure"]
impl crate::Readable for MrccLpuart5ClkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_lpuart5_clkdiv::W`](W) writer structure"]
impl crate::Writable for MrccLpuart5ClkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_LPUART5_CLKDIV to value 0x4000_0000"]
impl crate::Resettable for MrccLpuart5ClkdivSpec {
