#[doc = "Register `MRCC_SYSTICK_CLKSEL` reader"]
pub type R = crate::R<MrccSystickClkselSpec>;
#[doc = "Register `MRCC_SYSTICK_CLKSEL` writer"]
pub type W = crate::W<MrccSystickClkselSpec>;
...
impl W {
    #[doc = "Bits 0:1 - Functional Clock Mux Select"]
    #[inline(always)]
    pub fn mux(&mut self) -> MuxW<MrccSystickClkselSpec> {
        MuxW::new(self, 0)
    }
}
...
pub struct MrccSystickClkselSpec;
impl crate::RegisterSpec for MrccSystickClkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mrcc_systick_clksel::R`](R) reader structure"]
impl crate::Readable for MrccSystickClkselSpec {}
#[doc = "`write(|w| ..)` method takes [`mrcc_systick_clksel::W`](W) writer structure"]
impl crate::Writable for MrccSystickClkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MRCC_SYSTICK_CLKSEL to value 0x03"]
impl crate::Resettable for MrccSystickClkselSpec {
