...
impl From<Pv> for bool {
    #[inline(always)]
    fn from(variant: Pv) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `PV` reader - Pull Value"]
pub type PvR = crate::BitReader<Pv>;
impl PvR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Pv {
        match self.bits {
            false => Pv::Pv0,
            true => Pv::Pv1,
        }
    ...
    #[doc = "Low"]
    #[inline(always)]
    pub fn is_pv0(&self) -> bool {
        *self == Pv::Pv0
    }
    #[doc = "High"]
    #[inline(always)]
    pub fn is_pv1(&self) -> bool {
        *self == Pv::Pv1
    }
}
#[doc = "Field `PV` writer - Pull Value"]
pub type PvW<'a, REG> = crate::BitWriter<'a, REG, Pv>;
impl<'a, REG> PvW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Low"]
    #[inline(always)]
    pub fn pv0(self) -> &'a mut crate::W<REG> {
        self.variant(Pv::Pv0)
    }
    #[doc = "High"]
    #[inline(always)]
    pub fn pv1(self) -> &'a mut crate::W<REG> {
        self.variant(Pv::Pv1)
    }
}
...
impl PfeR {
    ...
    #[doc = "Disables"]
    #[inline(always)]
    pub fn is_pfe0(&self) -> bool {
        *self == Pfe::Pfe0
    }
    #[doc = "Enables"]
    #[inline(always)]
    pub fn is_pfe1(&self) -> bool {
        *self == Pfe::Pfe1
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disables"]
    #[inline(always)]
    pub fn pfe0(self) -> &'a mut crate::W<REG> {
        self.variant(Pfe::Pfe0)
    }
    #[doc = "Enables"]
    #[inline(always)]
    pub fn pfe1(self) -> &'a mut crate::W<REG> {
        self.variant(Pfe::Pfe1)
    }
}
...
impl From<Dse1> for bool {
    #[inline(always)]
    fn from(variant: Dse1) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `DSE1` reader - Drive Strength Enable"]
pub type Dse1R = crate::BitReader<Dse1>;
impl Dse1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Dse1 {
        match self.bits {
            false => Dse1::Dse10,
            true => Dse1::Dse11,
        }
    ...
    #[doc = "Normal"]
    #[inline(always)]
    pub fn is_dse10(&self) -> bool {
        *self == Dse1::Dse10
    }
    #[doc = "Double"]
    #[inline(always)]
    pub fn is_dse11(&self) -> bool {
        *self == Dse1::Dse11
    }
}
#[doc = "Field `DSE1` writer - Drive Strength Enable"]
pub type Dse1W<'a, REG> = crate::BitWriter<'a, REG, Dse1>;
impl<'a, REG> Dse1W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Normal"]
    #[inline(always)]
    pub fn dse10(self) -> &'a mut crate::W<REG> {
        self.variant(Dse1::Dse10)
    }
    #[doc = "Double"]
    #[inline(always)]
    pub fn dse11(self) -> &'a mut crate::W<REG> {
        self.variant(Dse1::Dse11)
    }
}
...
pub enum Mux {
    ...
    Mux111 = 7,
    #[doc = "8: Alternative 8 (chip-specific)"]
    Mux1000 = 8,
    #[doc = "9: Alternative 9 (chip-specific)"]
    Mux1001 = 9,
    #[doc = "10: Alternative 10 (chip-specific)"]
    Mux1010 = 10,
    #[doc = "11: Alternative 11 (chip-specific)"]
    Mux1011 = 11,
    #[doc = "12: Alternative 12 (chip-specific)"]
    Mux1100 = 12,
    #[doc = "13: Alternative 13 (chip-specific)"]
    Mux1101 = 13,
}
...
pub type MuxW<'a, REG> = crate::FieldWriter<'a, REG, 4, Mux>;
...
impl R {
    ...
    #[doc = "Bit 2 - Pull Value"]
    #[inline(always)]
    pub fn pv(&self) -> PvR {
        PvR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[doc = "Bit 7 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse1(&self) -> Dse1R {
        Dse1R::new(((self.bits >> 7) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - Pull Select"]
    #[inline(always)]
    pub fn ps(&mut self) -> PsW<Pcr8Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    pub fn pe(&mut self) -> PeW<Pcr8Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 2 - Pull Value"]
    #[inline(always)]
    pub fn pv(&mut self) -> PvW<Pcr8Spec> {
        PvW::new(self, 2)
    }
    #[doc = "Bit 3 - Slew Rate Enable"]
    #[inline(always)]
    pub fn sre(&mut self) -> SreW<Pcr8Spec> {
        SreW::new(self, 3)
    }
    #[doc = "Bit 4 - Passive Filter Enable"]
    #[inline(always)]
    pub fn pfe(&mut self) -> PfeW<Pcr8Spec> {
        PfeW::new(self, 4)
    }
    #[doc = "Bit 5 - Open Drain Enable"]
    #[inline(always)]
    pub fn ode(&mut self) -> OdeW<Pcr8Spec> {
        OdeW::new(self, 5)
    }
    #[doc = "Bit 6 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse(&mut self) -> DseW<Pcr8Spec> {
        DseW::new(self, 6)
    }
    #[doc = "Bit 7 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse1(&mut self) -> Dse1W<Pcr8Spec> {
        Dse1W::new(self, 7)
    }
    #[doc = "Bits 8:11 - Pin Multiplex Control"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Input Buffer Enable"]
    #[inline(always)]
    pub fn ibe(&mut self) -> IbeW<Pcr8Spec> {
        IbeW::new(self, 12)
    }
    #[doc = "Bit 13 - Invert Input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<Pcr8Spec> {
        InvW::new(self, 13)
    }
    #[doc = "Bit 15 - Lock Register"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<Pcr8Spec> {
        LkW::new(self, 15)
    }
}
