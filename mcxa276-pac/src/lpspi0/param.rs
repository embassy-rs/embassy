...
pub type PcsnumR = crate::FieldReader;
impl R {
    ...
    pub fn pcsnum(&self) -> PcsnumR {
        PcsnumR::new(((self.bits >> 16) & 0xff) as u8)
    }
}
...
#[doc = "`reset()` method sets PARAM to value 0x0004_0202"]
impl crate::Resettable for ParamSpec {
    const RESET_VALUE: u32 = 0x0004_0202;
}
