#[doc = "Register `BFCRT233` reader"]
pub type R = crate::R<Bfcrt233Spec>;
#[doc = "Register `BFCRT233` writer"]
pub type W = crate::W<Bfcrt233Spec>;
...
impl W {
    #[doc = "Bits 0:1 - Product Term 3, Input D Configuration"]
    #[inline(always)]
    pub fn pt3_dc(&mut self) -> Pt3DcW<Bfcrt233Spec> {
        Pt3DcW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Product Term 3, Input C Configuration"]
    #[inline(always)]
    pub fn pt3_cc(&mut self) -> Pt3CcW<Bfcrt233Spec> {
        Pt3CcW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Product Term 3, Input B Configuration"]
    #[inline(always)]
    pub fn pt3_bc(&mut self) -> Pt3BcW<Bfcrt233Spec> {
        Pt3BcW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Product Term 3, Input A Configuration"]
    #[inline(always)]
    pub fn pt3_ac(&mut self) -> Pt3AcW<Bfcrt233Spec> {
        Pt3AcW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Product Term 2, Input D Configuration"]
    #[inline(always)]
    pub fn pt2_dc(&mut self) -> Pt2DcW<Bfcrt233Spec> {
        Pt2DcW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Product Term 2, Input C Configuration"]
    #[inline(always)]
    pub fn pt2_cc(&mut self) -> Pt2CcW<Bfcrt233Spec> {
        Pt2CcW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Product Term 2, Input B Configuration"]
    #[inline(always)]
    pub fn pt2_bc(&mut self) -> Pt2BcW<Bfcrt233Spec> {
        Pt2BcW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Product Term 2, Input A Configuration"]
    #[inline(always)]
    pub fn pt2_ac(&mut self) -> Pt2AcW<Bfcrt233Spec> {
        Pt2AcW::new(self, 14)
    }
}
#[doc = "Boolean Function Term 2 and 3 Configuration for EVENT3\n\nYou can [`read`](crate::Reg::read) this register and get [`bfcrt233::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bfcrt233::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Bfcrt233Spec;
impl crate::RegisterSpec for Bfcrt233Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`bfcrt233::R`](R) reader structure"]
impl crate::Readable for Bfcrt233Spec {}
#[doc = "`write(|w| ..)` method takes [`bfcrt233::W`](W) writer structure"]
impl crate::Writable for Bfcrt233Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BFCRT233 to value 0"]
impl crate::Resettable for Bfcrt233Spec {}
