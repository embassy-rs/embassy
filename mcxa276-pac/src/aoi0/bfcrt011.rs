#[doc = "Register `BFCRT011` reader"]
pub type R = crate::R<Bfcrt011Spec>;
#[doc = "Register `BFCRT011` writer"]
pub type W = crate::W<Bfcrt011Spec>;
...
impl W {
    #[doc = "Bits 0:1 - Product Term 1, Input D Configuration"]
    #[inline(always)]
    pub fn pt1_dc(&mut self) -> Pt1DcW<Bfcrt011Spec> {
        Pt1DcW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Product Term 1, Input C Configuration"]
    #[inline(always)]
    pub fn pt1_cc(&mut self) -> Pt1CcW<Bfcrt011Spec> {
        Pt1CcW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Product Term 1, Input B Configuration"]
    #[inline(always)]
    pub fn pt1_bc(&mut self) -> Pt1BcW<Bfcrt011Spec> {
        Pt1BcW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Product Term 1, Input A Configuration"]
    #[inline(always)]
    pub fn pt1_ac(&mut self) -> Pt1AcW<Bfcrt011Spec> {
        Pt1AcW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Product Term 0, Input D Configuration"]
    #[inline(always)]
    pub fn pt0_dc(&mut self) -> Pt0DcW<Bfcrt011Spec> {
        Pt0DcW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Product Term 0, Input C Configuration"]
    #[inline(always)]
    pub fn pt0_cc(&mut self) -> Pt0CcW<Bfcrt011Spec> {
        Pt0CcW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Product Term 0, Input B Configuration"]
    #[inline(always)]
    pub fn pt0_bc(&mut self) -> Pt0BcW<Bfcrt011Spec> {
        Pt0BcW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Product Term 0, Input A Configuration"]
    #[inline(always)]
    pub fn pt0_ac(&mut self) -> Pt0AcW<Bfcrt011Spec> {
        Pt0AcW::new(self, 14)
    }
}
#[doc = "Boolean Function Term 0 and 1 Configuration for EVENT1\n\nYou can [`read`](crate::Reg::read) this register and get [`bfcrt011::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bfcrt011::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Bfcrt011Spec;
impl crate::RegisterSpec for Bfcrt011Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`bfcrt011::R`](R) reader structure"]
impl crate::Readable for Bfcrt011Spec {}
#[doc = "`write(|w| ..)` method takes [`bfcrt011::W`](W) writer structure"]
impl crate::Writable for Bfcrt011Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BFCRT011 to value 0"]
impl crate::Resettable for Bfcrt011Spec {}
