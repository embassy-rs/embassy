...
impl W {
    #[doc = "Bit 0 - Pull Select"]
    #[inline(always)]
    pub fn ps(&mut self) -> PsW<Pcr15Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    pub fn pe(&mut self) -> PeW<Pcr15Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 3 - Slew Rate Enable"]
    #[inline(always)]
    pub fn sre(&mut self) -> SreW<Pcr15Spec> {
        SreW::new(self, 3)
    }
    #[doc = "Bit 5 - Open Drain Enable"]
    #[inline(always)]
    pub fn ode(&mut self) -> OdeW<Pcr15Spec> {
        OdeW::new(self, 5)
    }
    #[doc = "Bit 6 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse(&mut self) -> DseW<Pcr15Spec> {
        DseW::new(self, 6)
    }
    #[doc = "Bits 8:11 - Pin Multiplex Control"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Input Buffer Enable"]
    #[inline(always)]
    pub fn ibe(&mut self) -> IbeW<Pcr15Spec> {
        IbeW::new(self, 12)
    }
    #[doc = "Bit 13 - Invert Input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<Pcr15Spec> {
        InvW::new(self, 13)
    }
    #[doc = "Bit 15 - Lock Register"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<Pcr15Spec> {
        LkW::new(self, 15)
    }
}
