#[doc = "Register `MBC0_MEMN_GLBAC0` reader"]
pub type R = crate::R<Mbc0MemnGlbac0Spec>;
#[doc = "Register `MBC0_MEMN_GLBAC0` writer"]
pub type W = crate::W<Mbc0MemnGlbac0Spec>;
...
impl W {
    #[doc = "Bit 0 - NonsecureUser Execute"]
    #[inline(always)]
    pub fn nux(&mut self) -> NuxW<Mbc0MemnGlbac0Spec> {
        NuxW::new(self, 0)
    }
    #[doc = "Bit 1 - NonsecureUser Write"]
    #[inline(always)]
    pub fn nuw(&mut self) -> NuwW<Mbc0MemnGlbac0Spec> {
        NuwW::new(self, 1)
    }
    #[doc = "Bit 2 - NonsecureUser Read"]
    #[inline(always)]
    pub fn nur(&mut self) -> NurW<Mbc0MemnGlbac0Spec> {
        NurW::new(self, 2)
    }
    #[doc = "Bit 4 - NonsecurePriv Execute"]
    #[inline(always)]
    pub fn npx(&mut self) -> NpxW<Mbc0MemnGlbac0Spec> {
        NpxW::new(self, 4)
    }
    #[doc = "Bit 5 - NonsecurePriv Write"]
    #[inline(always)]
    pub fn npw(&mut self) -> NpwW<Mbc0MemnGlbac0Spec> {
        NpwW::new(self, 5)
    }
    #[doc = "Bit 6 - NonsecurePriv Read"]
    #[inline(always)]
    pub fn npr(&mut self) -> NprW<Mbc0MemnGlbac0Spec> {
        NprW::new(self, 6)
    }
    #[doc = "Bit 8 - SecureUser Execute"]
    #[inline(always)]
    pub fn sux(&mut self) -> SuxW<Mbc0MemnGlbac0Spec> {
        SuxW::new(self, 8)
    }
    #[doc = "Bit 9 - SecureUser Write"]
    #[inline(always)]
    pub fn suw(&mut self) -> SuwW<Mbc0MemnGlbac0Spec> {
        SuwW::new(self, 9)
    }
    #[doc = "Bit 10 - SecureUser Read"]
    #[inline(always)]
    pub fn sur(&mut self) -> SurW<Mbc0MemnGlbac0Spec> {
        SurW::new(self, 10)
    }
    #[doc = "Bit 12 - SecurePriv Execute"]
    #[inline(always)]
    pub fn spx(&mut self) -> SpxW<Mbc0MemnGlbac0Spec> {
        SpxW::new(self, 12)
    }
    #[doc = "Bit 13 - SecurePriv Write"]
    #[inline(always)]
    pub fn spw(&mut self) -> SpwW<Mbc0MemnGlbac0Spec> {
        SpwW::new(self, 13)
    }
    #[doc = "Bit 14 - SecurePriv Read"]
    #[inline(always)]
    pub fn spr(&mut self) -> SprW<Mbc0MemnGlbac0Spec> {
        SprW::new(self, 14)
    }
}
...
pub struct Mbc0MemnGlbac0Spec;
impl crate::RegisterSpec for Mbc0MemnGlbac0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mbc0_memn_glbac0::R`](R) reader structure"]
impl crate::Readable for Mbc0MemnGlbac0Spec {}
#[doc = "`write(|w| ..)` method takes [`mbc0_memn_glbac0::W`](W) writer structure"]
impl crate::Writable for Mbc0MemnGlbac0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MBC0_MEMN_GLBAC0 to value 0x6600"]
impl crate::Resettable for Mbc0MemnGlbac0Spec {
    const RESET_VALUE: u32 = 0x6600;
}
