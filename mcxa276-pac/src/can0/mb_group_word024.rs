...
pub type R = crate::R<MbGroupWord024Spec>;
#[doc = "Register `WORD024` writer"]
pub type W = crate::W<MbGroupWord024Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_3(&mut self) -> DataByte3W<MbGroupWord024Spec> {
        DataByte3W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_2(&mut self) -> DataByte2W<MbGroupWord024Spec> {
        DataByte2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_1(&mut self) -> DataByte1W<MbGroupWord024Spec> {
        DataByte1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_0(&mut self) -> DataByte0W<MbGroupWord024Spec> {
...
pub struct MbGroupWord024Spec;
impl crate::RegisterSpec for MbGroupWord024Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_word024::R`](R) reader structure"]
impl crate::Readable for MbGroupWord024Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_word024::W`](W) writer structure"]
impl crate::Writable for MbGroupWord024Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD024 to value 0"]
impl crate::Resettable for MbGroupWord024Spec {}
