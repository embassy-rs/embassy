#[doc = "Register `MB6_16B_WORD3` reader"]
pub type R = crate::R<Mb16bGroupMb6_16bWord3Spec>;
#[doc = "Register `MB6_16B_WORD3` writer"]
pub type W = crate::W<Mb16bGroupMb6_16bWord3Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_15(&mut self) -> DataByte15W<Mb16bGroupMb6_16bWord3Spec> {
        DataByte15W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_14(&mut self) -> DataByte14W<Mb16bGroupMb6_16bWord3Spec> {
        DataByte14W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_13(&mut self) -> DataByte13W<Mb16bGroupMb6_16bWord3Spec> {
        DataByte13W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_12(&mut self) -> DataByte12W<Mb16bGroupMb6_16bWord3Spec> {
...
pub struct Mb16bGroupMb6_16bWord3Spec;
impl crate::RegisterSpec for Mb16bGroupMb6_16bWord3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_16b_group_mb6_16b_word3::R`](R) reader structure"]
impl crate::Readable for Mb16bGroupMb6_16bWord3Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_16b_group_mb6_16b_word3::W`](W) writer structure"]
impl crate::Writable for Mb16bGroupMb6_16bWord3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB6_16B_WORD3 to value 0"]
impl crate::Resettable for Mb16bGroupMb6_16bWord3Spec {}
