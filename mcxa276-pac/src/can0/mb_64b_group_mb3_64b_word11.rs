#[doc = "Register `MB3_64B_WORD11` reader"]
pub type R = crate::R<Mb64bGroupMb3_64bWord11Spec>;
#[doc = "Register `MB3_64B_WORD11` writer"]
pub type W = crate::W<Mb64bGroupMb3_64bWord11Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_47(&mut self) -> DataByte47W<Mb64bGroupMb3_64bWord11Spec> {
        DataByte47W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_46(&mut self) -> DataByte46W<Mb64bGroupMb3_64bWord11Spec> {
        DataByte46W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_45(&mut self) -> DataByte45W<Mb64bGroupMb3_64bWord11Spec> {
        DataByte45W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_44(&mut self) -> DataByte44W<Mb64bGroupMb3_64bWord11Spec> {
...
pub struct Mb64bGroupMb3_64bWord11Spec;
impl crate::RegisterSpec for Mb64bGroupMb3_64bWord11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb3_64b_word11::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb3_64bWord11Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb3_64b_word11::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb3_64bWord11Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB3_64B_WORD11 to value 0"]
impl crate::Resettable for Mb64bGroupMb3_64bWord11Spec {}
