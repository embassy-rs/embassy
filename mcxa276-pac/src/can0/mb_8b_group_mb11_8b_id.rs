#[doc = "Register `MB11_8B_ID` reader"]
pub type R = crate::R<Mb8bGroupMb11_8bIdSpec>;
#[doc = "Register `MB11_8B_ID` writer"]
pub type W = crate::W<Mb8bGroupMb11_8bIdSpec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<Mb8bGroupMb11_8bIdSpec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<Mb8bGroupMb11_8bIdSpec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<Mb8bGroupMb11_8bIdSpec> {
        PrioW::new(self, 29)
    }
}
...
pub struct Mb8bGroupMb11_8bIdSpec;
impl crate::RegisterSpec for Mb8bGroupMb11_8bIdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_8b_group_mb11_8b_id::R`](R) reader structure"]
impl crate::Readable for Mb8bGroupMb11_8bIdSpec {}
#[doc = "`write(|w| ..)` method takes [`mb_8b_group_mb11_8b_id::W`](W) writer structure"]
impl crate::Writable for Mb8bGroupMb11_8bIdSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB11_8B_ID to value 0"]
impl crate::Resettable for Mb8bGroupMb11_8bIdSpec {}
