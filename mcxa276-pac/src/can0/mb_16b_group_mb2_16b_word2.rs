#[doc = "Register `MB2_16B_WORD2` reader"]
pub type R = crate::R<Mb16bGroupMb2_16bWord2Spec>;
#[doc = "Register `MB2_16B_WORD2` writer"]
pub type W = crate::W<Mb16bGroupMb2_16bWord2Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_11(&mut self) -> DataByte11W<Mb16bGroupMb2_16bWord2Spec> {
        DataByte11W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_10(&mut self) -> DataByte10W<Mb16bGroupMb2_16bWord2Spec> {
        DataByte10W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_9(&mut self) -> DataByte9W<Mb16bGroupMb2_16bWord2Spec> {
        DataByte9W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_8(&mut self) -> DataByte8W<Mb16bGroupMb2_16bWord2Spec> {
...
pub struct Mb16bGroupMb2_16bWord2Spec;
impl crate::RegisterSpec for Mb16bGroupMb2_16bWord2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_16b_group_mb2_16b_word2::R`](R) reader structure"]
impl crate::Readable for Mb16bGroupMb2_16bWord2Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_16b_group_mb2_16b_word2::W`](W) writer structure"]
impl crate::Writable for Mb16bGroupMb2_16bWord2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB2_16B_WORD2 to value 0"]
impl crate::Resettable for Mb16bGroupMb2_16bWord2Spec {}
