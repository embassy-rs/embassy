#[doc = "Register `MB5_64B_WORD14` reader"]
pub type R = crate::R<Mb64bGroupMb5_64bWord14Spec>;
#[doc = "Register `MB5_64B_WORD14` writer"]
pub type W = crate::W<Mb64bGroupMb5_64bWord14Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_59(&mut self) -> DataByte59W<Mb64bGroupMb5_64bWord14Spec> {
        DataByte59W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_58(&mut self) -> DataByte58W<Mb64bGroupMb5_64bWord14Spec> {
        DataByte58W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_57(&mut self) -> DataByte57W<Mb64bGroupMb5_64bWord14Spec> {
        DataByte57W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_56(&mut self) -> DataByte56W<Mb64bGroupMb5_64bWord14Spec> {
...
pub struct Mb64bGroupMb5_64bWord14Spec;
impl crate::RegisterSpec for Mb64bGroupMb5_64bWord14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb5_64b_word14::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb5_64bWord14Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb5_64b_word14::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb5_64bWord14Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB5_64B_WORD14 to value 0"]
impl crate::Resettable for Mb64bGroupMb5_64bWord14Spec {}
