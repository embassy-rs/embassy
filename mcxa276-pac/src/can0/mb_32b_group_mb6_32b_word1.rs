#[doc = "Register `MB6_32B_WORD1` reader"]
pub type R = crate::R<Mb32bGroupMb6_32bWord1Spec>;
#[doc = "Register `MB6_32B_WORD1` writer"]
pub type W = crate::W<Mb32bGroupMb6_32bWord1Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<Mb32bGroupMb6_32bWord1Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<Mb32bGroupMb6_32bWord1Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<Mb32bGroupMb6_32bWord1Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<Mb32bGroupMb6_32bWord1Spec> {
...
pub struct Mb32bGroupMb6_32bWord1Spec;
impl crate::RegisterSpec for Mb32bGroupMb6_32bWord1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_32b_group_mb6_32b_word1::R`](R) reader structure"]
impl crate::Readable for Mb32bGroupMb6_32bWord1Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_32b_group_mb6_32b_word1::W`](W) writer structure"]
impl crate::Writable for Mb32bGroupMb6_32bWord1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB6_32B_WORD1 to value 0"]
impl crate::Resettable for Mb32bGroupMb6_32bWord1Spec {}
