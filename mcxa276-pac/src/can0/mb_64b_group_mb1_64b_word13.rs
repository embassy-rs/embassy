#[doc = "Register `MB1_64B_WORD13` reader"]
pub type R = crate::R<Mb64bGroupMb1_64bWord13Spec>;
#[doc = "Register `MB1_64B_WORD13` writer"]
pub type W = crate::W<Mb64bGroupMb1_64bWord13Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_55(&mut self) -> DataByte55W<Mb64bGroupMb1_64bWord13Spec> {
        DataByte55W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_54(&mut self) -> DataByte54W<Mb64bGroupMb1_64bWord13Spec> {
        DataByte54W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_53(&mut self) -> DataByte53W<Mb64bGroupMb1_64bWord13Spec> {
        DataByte53W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_52(&mut self) -> DataByte52W<Mb64bGroupMb1_64bWord13Spec> {
...
pub struct Mb64bGroupMb1_64bWord13Spec;
impl crate::RegisterSpec for Mb64bGroupMb1_64bWord13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb1_64b_word13::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb1_64bWord13Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb1_64b_word13::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb1_64bWord13Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB1_64B_WORD13 to value 0"]
impl crate::Resettable for Mb64bGroupMb1_64bWord13Spec {}
