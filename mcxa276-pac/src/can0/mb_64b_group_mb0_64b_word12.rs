#[doc = "Register `MB0_64B_WORD12` reader"]
pub type R = crate::R<Mb64bGroupMb0_64bWord12Spec>;
#[doc = "Register `MB0_64B_WORD12` writer"]
pub type W = crate::W<Mb64bGroupMb0_64bWord12Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_51(&mut self) -> DataByte51W<Mb64bGroupMb0_64bWord12Spec> {
        DataByte51W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_50(&mut self) -> DataByte50W<Mb64bGroupMb0_64bWord12Spec> {
        DataByte50W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_49(&mut self) -> DataByte49W<Mb64bGroupMb0_64bWord12Spec> {
        DataByte49W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_48(&mut self) -> DataByte48W<Mb64bGroupMb0_64bWord12Spec> {
...
pub struct Mb64bGroupMb0_64bWord12Spec;
impl crate::RegisterSpec for Mb64bGroupMb0_64bWord12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb0_64b_word12::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb0_64bWord12Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb0_64b_word12::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb0_64bWord12Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB0_64B_WORD12 to value 0"]
impl crate::Resettable for Mb64bGroupMb0_64bWord12Spec {}
