#[doc = "Register `MB4_64B_ID` reader"]
pub type R = crate::R<Mb64bGroupMb4_64bIdSpec>;
#[doc = "Register `MB4_64B_ID` writer"]
pub type W = crate::W<Mb64bGroupMb4_64bIdSpec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<Mb64bGroupMb4_64bIdSpec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<Mb64bGroupMb4_64bIdSpec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<Mb64bGroupMb4_64bIdSpec> {
        PrioW::new(self, 29)
    }
}
...
pub struct Mb64bGroupMb4_64bIdSpec;
impl crate::RegisterSpec for Mb64bGroupMb4_64bIdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb4_64b_id::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb4_64bIdSpec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb4_64b_id::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb4_64bIdSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB4_64B_ID to value 0"]
impl crate::Resettable for Mb64bGroupMb4_64bIdSpec {}
