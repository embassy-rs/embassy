...
pub type R = crate::R<MbGroupId7Spec>;
#[doc = "Register `ID7` writer"]
pub type W = crate::W<MbGroupId7Spec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<MbGroupId7Spec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<MbGroupId7Spec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<MbGroupId7Spec> {
        PrioW::new(self, 29)
    }
}
...
pub struct MbGroupId7Spec;
impl crate::RegisterSpec for MbGroupId7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_id7::R`](R) reader structure"]
impl crate::Readable for MbGroupId7Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_id7::W`](W) writer structure"]
impl crate::Writable for MbGroupId7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ID7 to value 0"]
impl crate::Resettable for MbGroupId7Spec {}
