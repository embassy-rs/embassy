#[doc = "Register `MB1_64B_CS` reader"]
pub type R = crate::R<Mb64bGroupMb1_64bCsSpec>;
#[doc = "Register `MB1_64B_CS` writer"]
pub type W = crate::W<Mb64bGroupMb1_64bCsSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Free-Running Counter Time stamp. This 16-bit field is a copy of the Free-Running Timer, captured for Tx and Rx frames at the time when the beginning of the Identifier field appears on the CAN bus."]
    #[inline(always)]
    pub fn time_stamp(&mut self) -> TimeStampW<Mb64bGroupMb1_64bCsSpec> {
        TimeStampW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Length of the data to be stored/transmitted."]
    #[inline(always)]
    pub fn dlc(&mut self) -> DlcW<Mb64bGroupMb1_64bCsSpec> {
        DlcW::new(self, 16)
    }
    #[doc = "Bit 20 - Remote Transmission Request. One/zero for remote/data frame."]
    #[inline(always)]
    pub fn rtr(&mut self) -> RtrW<Mb64bGroupMb1_64bCsSpec> {
        RtrW::new(self, 20)
    }
    #[doc = "Bit 21 - ID Extended. One/zero for extended/standard format frame."]
    #[inline(always)]
    pub fn ide(&mut self) -> IdeW<Mb64bGroupMb1_64bCsSpec> {
        IdeW::new(self, 21)
    }
    #[doc = "Bit 22 - Substitute Remote Request. Contains a fixed recessive bit."]
    #[inline(always)]
    pub fn srr(&mut self) -> SrrW<Mb64bGroupMb1_64bCsSpec> {
        SrrW::new(self, 22)
    }
    #[doc = "Bits 24:27 - Message Buffer Code. This 4-bit field can be accessed (read or write) by the CPU and by the FlexCAN module itself, as part of the message buffer matching and arbitration process."]
    #[inline(always)]
    pub fn code(&mut self) -> CodeW<Mb64bGroupMb1_64bCsSpec> {
        CodeW::new(self, 24)
    }
    #[doc = "Bit 29 - Error State Indicator. This bit indicates if the transmitting node is error active or error passive."]
    #[inline(always)]
    pub fn esi(&mut self) -> EsiW<Mb64bGroupMb1_64bCsSpec> {
        EsiW::new(self, 29)
    }
    #[doc = "Bit 30 - Bit Rate Switch. This bit defines whether the bit rate is switched inside a CAN FD format frame."]
    #[inline(always)]
    pub fn brs(&mut self) -> BrsW<Mb64bGroupMb1_64bCsSpec> {
        BrsW::new(self, 30)
    }
    #[doc = "Bit 31 - Extended Data Length. This bit distinguishes between CAN format and CAN FD format frames. The EDL bit must not be set for Message Buffers configured to RANSWER with code field 0b1010."]
    #[inline(always)]
    pub fn edl(&mut self) -> EdlW<Mb64bGroupMb1_64bCsSpec> {
        EdlW::new(self, 31)
    }
}
...
pub struct Mb64bGroupMb1_64bCsSpec;
impl crate::RegisterSpec for Mb64bGroupMb1_64bCsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb1_64b_cs::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb1_64bCsSpec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb1_64b_cs::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb1_64bCsSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB1_64B_CS to value 0"]
impl crate::Resettable for Mb64bGroupMb1_64bCsSpec {}
