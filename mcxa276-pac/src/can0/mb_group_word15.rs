...
pub type R = crate::R<MbGroupWord15Spec>;
#[doc = "Register `WORD15` writer"]
pub type W = crate::W<MbGroupWord15Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<MbGroupWord15Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<MbGroupWord15Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<MbGroupWord15Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<MbGroupWord15Spec> {
...
pub struct MbGroupWord15Spec;
impl crate::RegisterSpec for MbGroupWord15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_word15::R`](R) reader structure"]
impl crate::Readable for MbGroupWord15Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_word15::W`](W) writer structure"]
impl crate::Writable for MbGroupWord15Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD15 to value 0"]
impl crate::Resettable for MbGroupWord15Spec {}
