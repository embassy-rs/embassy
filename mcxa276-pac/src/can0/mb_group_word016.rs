...
pub type R = crate::R<MbGroupWord016Spec>;
#[doc = "Register `WORD016` writer"]
pub type W = crate::W<MbGroupWord016Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_3(&mut self) -> DataByte3W<MbGroupWord016Spec> {
        DataByte3W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_2(&mut self) -> DataByte2W<MbGroupWord016Spec> {
        DataByte2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_1(&mut self) -> DataByte1W<MbGroupWord016Spec> {
        DataByte1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_0(&mut self) -> DataByte0W<MbGroupWord016Spec> {
...
pub struct MbGroupWord016Spec;
impl crate::RegisterSpec for MbGroupWord016Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_word016::R`](R) reader structure"]
impl crate::Readable for MbGroupWord016Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_word016::W`](W) writer structure"]
impl crate::Writable for MbGroupWord016Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD016 to value 0"]
impl crate::Resettable for MbGroupWord016Spec {}
