...
pub type R = crate::R<MbGroupWord111Spec>;
#[doc = "Register `WORD111` writer"]
pub type W = crate::W<MbGroupWord111Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<MbGroupWord111Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<MbGroupWord111Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<MbGroupWord111Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<MbGroupWord111Spec> {
...
pub struct MbGroupWord111Spec;
impl crate::RegisterSpec for MbGroupWord111Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_word111::R`](R) reader structure"]
impl crate::Readable for MbGroupWord111Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_word111::W`](W) writer structure"]
impl crate::Writable for MbGroupWord111Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD111 to value 0"]
impl crate::Resettable for MbGroupWord111Spec {}
