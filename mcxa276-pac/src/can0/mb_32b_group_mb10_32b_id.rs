#[doc = "Register `MB10_32B_ID` reader"]
pub type R = crate::R<Mb32bGroupMb10_32bIdSpec>;
#[doc = "Register `MB10_32B_ID` writer"]
pub type W = crate::W<Mb32bGroupMb10_32bIdSpec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<Mb32bGroupMb10_32bIdSpec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<Mb32bGroupMb10_32bIdSpec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<Mb32bGroupMb10_32bIdSpec> {
        PrioW::new(self, 29)
    }
}
...
pub struct Mb32bGroupMb10_32bIdSpec;
impl crate::RegisterSpec for Mb32bGroupMb10_32bIdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_32b_group_mb10_32b_id::R`](R) reader structure"]
impl crate::Readable for Mb32bGroupMb10_32bIdSpec {}
#[doc = "`write(|w| ..)` method takes [`mb_32b_group_mb10_32b_id::W`](W) writer structure"]
impl crate::Writable for Mb32bGroupMb10_32bIdSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB10_32B_ID to value 0"]
impl crate::Resettable for Mb32bGroupMb10_32bIdSpec {}
