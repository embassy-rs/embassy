#[doc = "Register `MB11_32B_WORD5` reader"]
pub type R = crate::R<Mb32bGroupMb11_32bWord5Spec>;
#[doc = "Register `MB11_32B_WORD5` writer"]
pub type W = crate::W<Mb32bGroupMb11_32bWord5Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_23(&mut self) -> DataByte23W<Mb32bGroupMb11_32bWord5Spec> {
        DataByte23W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_22(&mut self) -> DataByte22W<Mb32bGroupMb11_32bWord5Spec> {
        DataByte22W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_21(&mut self) -> DataByte21W<Mb32bGroupMb11_32bWord5Spec> {
        DataByte21W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_20(&mut self) -> DataByte20W<Mb32bGroupMb11_32bWord5Spec> {
...
pub struct Mb32bGroupMb11_32bWord5Spec;
impl crate::RegisterSpec for Mb32bGroupMb11_32bWord5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_32b_group_mb11_32b_word5::R`](R) reader structure"]
impl crate::Readable for Mb32bGroupMb11_32bWord5Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_32b_group_mb11_32b_word5::W`](W) writer structure"]
impl crate::Writable for Mb32bGroupMb11_32bWord5Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB11_32B_WORD5 to value 0"]
impl crate::Resettable for Mb32bGroupMb11_32bWord5Spec {}
