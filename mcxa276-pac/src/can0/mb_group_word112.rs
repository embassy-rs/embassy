...
pub type R = crate::R<MbGroupWord112Spec>;
#[doc = "Register `WORD112` writer"]
pub type W = crate::W<MbGroupWord112Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<MbGroupWord112Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<MbGroupWord112Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<MbGroupWord112Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<MbGroupWord112Spec> {
...
pub struct MbGroupWord112Spec;
impl crate::RegisterSpec for MbGroupWord112Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_word112::R`](R) reader structure"]
impl crate::Readable for MbGroupWord112Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_word112::W`](W) writer structure"]
impl crate::Writable for MbGroupWord112Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD112 to value 0"]
impl crate::Resettable for MbGroupWord112Spec {}
