#[doc = "Register `MB3_32B_WORD4` reader"]
pub type R = crate::R<Mb32bGroupMb3_32bWord4Spec>;
#[doc = "Register `MB3_32B_WORD4` writer"]
pub type W = crate::W<Mb32bGroupMb3_32bWord4Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_19(&mut self) -> DataByte19W<Mb32bGroupMb3_32bWord4Spec> {
        DataByte19W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_18(&mut self) -> DataByte18W<Mb32bGroupMb3_32bWord4Spec> {
        DataByte18W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_17(&mut self) -> DataByte17W<Mb32bGroupMb3_32bWord4Spec> {
        DataByte17W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_16(&mut self) -> DataByte16W<Mb32bGroupMb3_32bWord4Spec> {
...
pub struct Mb32bGroupMb3_32bWord4Spec;
impl crate::RegisterSpec for Mb32bGroupMb3_32bWord4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_32b_group_mb3_32b_word4::R`](R) reader structure"]
impl crate::Readable for Mb32bGroupMb3_32bWord4Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_32b_group_mb3_32b_word4::W`](W) writer structure"]
impl crate::Writable for Mb32bGroupMb3_32bWord4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB3_32B_WORD4 to value 0"]
impl crate::Resettable for Mb32bGroupMb3_32bWord4Spec {}
