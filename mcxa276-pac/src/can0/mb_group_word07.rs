...
pub type R = crate::R<MbGroupWord07Spec>;
#[doc = "Register `WORD07` writer"]
pub type W = crate::W<MbGroupWord07Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_3(&mut self) -> DataByte3W<MbGroupWord07Spec> {
        DataByte3W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_2(&mut self) -> DataByte2W<MbGroupWord07Spec> {
        DataByte2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_1(&mut self) -> DataByte1W<MbGroupWord07Spec> {
        DataByte1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_0(&mut self) -> DataByte0W<MbGroupWord07Spec> {
...
pub struct MbGroupWord07Spec;
impl crate::RegisterSpec for MbGroupWord07Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_word07::R`](R) reader structure"]
impl crate::Readable for MbGroupWord07Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_word07::W`](W) writer structure"]
impl crate::Writable for MbGroupWord07Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD07 to value 0"]
impl crate::Resettable for MbGroupWord07Spec {}
