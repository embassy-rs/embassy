#[doc = "Register `MB3_64B_WORD15` reader"]
pub type R = crate::R<Mb64bGroupMb3_64bWord15Spec>;
#[doc = "Register `MB3_64B_WORD15` writer"]
pub type W = crate::W<Mb64bGroupMb3_64bWord15Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_63(&mut self) -> DataByte63W<Mb64bGroupMb3_64bWord15Spec> {
        DataByte63W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_62(&mut self) -> DataByte62W<Mb64bGroupMb3_64bWord15Spec> {
        DataByte62W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_61(&mut self) -> DataByte61W<Mb64bGroupMb3_64bWord15Spec> {
        DataByte61W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_60(&mut self) -> DataByte60W<Mb64bGroupMb3_64bWord15Spec> {
...
pub struct Mb64bGroupMb3_64bWord15Spec;
impl crate::RegisterSpec for Mb64bGroupMb3_64bWord15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb3_64b_word15::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb3_64bWord15Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb3_64b_word15::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb3_64bWord15Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB3_64B_WORD15 to value 0"]
impl crate::Resettable for Mb64bGroupMb3_64bWord15Spec {}
