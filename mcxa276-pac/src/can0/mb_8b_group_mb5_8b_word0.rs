#[doc = "Register `MB5_8B_WORD0` reader"]
pub type R = crate::R<Mb8bGroupMb5_8bWord0Spec>;
#[doc = "Register `MB5_8B_WORD0` writer"]
pub type W = crate::W<Mb8bGroupMb5_8bWord0Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_3(&mut self) -> DataByte3W<Mb8bGroupMb5_8bWord0Spec> {
        DataByte3W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_2(&mut self) -> DataByte2W<Mb8bGroupMb5_8bWord0Spec> {
        DataByte2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_1(&mut self) -> DataByte1W<Mb8bGroupMb5_8bWord0Spec> {
        DataByte1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_0(&mut self) -> DataByte0W<Mb8bGroupMb5_8bWord0Spec> {
...
pub struct Mb8bGroupMb5_8bWord0Spec;
impl crate::RegisterSpec for Mb8bGroupMb5_8bWord0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_8b_group_mb5_8b_word0::R`](R) reader structure"]
impl crate::Readable for Mb8bGroupMb5_8bWord0Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_8b_group_mb5_8b_word0::W`](W) writer structure"]
impl crate::Writable for Mb8bGroupMb5_8bWord0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB5_8B_WORD0 to value 0"]
impl crate::Resettable for Mb8bGroupMb5_8bWord0Spec {}
