#[doc = "Register `MB8_32B_WORD6` reader"]
pub type R = crate::R<Mb32bGroupMb8_32bWord6Spec>;
#[doc = "Register `MB8_32B_WORD6` writer"]
pub type W = crate::W<Mb32bGroupMb8_32bWord6Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_27(&mut self) -> DataByte27W<Mb32bGroupMb8_32bWord6Spec> {
        DataByte27W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_26(&mut self) -> DataByte26W<Mb32bGroupMb8_32bWord6Spec> {
        DataByte26W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_25(&mut self) -> DataByte25W<Mb32bGroupMb8_32bWord6Spec> {
        DataByte25W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_24(&mut self) -> DataByte24W<Mb32bGroupMb8_32bWord6Spec> {
...
pub struct Mb32bGroupMb8_32bWord6Spec;
impl crate::RegisterSpec for Mb32bGroupMb8_32bWord6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_32b_group_mb8_32b_word6::R`](R) reader structure"]
impl crate::Readable for Mb32bGroupMb8_32bWord6Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_32b_group_mb8_32b_word6::W`](W) writer structure"]
impl crate::Writable for Mb32bGroupMb8_32bWord6Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB8_32B_WORD6 to value 0"]
impl crate::Resettable for Mb32bGroupMb8_32bWord6Spec {}
