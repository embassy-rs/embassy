#[doc = "Register `MB0_16B_ID` reader"]
pub type R = crate::R<Mb16bGroupMb0_16bIdSpec>;
#[doc = "Register `MB0_16B_ID` writer"]
pub type W = crate::W<Mb16bGroupMb0_16bIdSpec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<Mb16bGroupMb0_16bIdSpec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<Mb16bGroupMb0_16bIdSpec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<Mb16bGroupMb0_16bIdSpec> {
        PrioW::new(self, 29)
    }
}
...
pub struct Mb16bGroupMb0_16bIdSpec;
impl crate::RegisterSpec for Mb16bGroupMb0_16bIdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_16b_group_mb0_16b_id::R`](R) reader structure"]
impl crate::Readable for Mb16bGroupMb0_16bIdSpec {}
#[doc = "`write(|w| ..)` method takes [`mb_16b_group_mb0_16b_id::W`](W) writer structure"]
impl crate::Writable for Mb16bGroupMb0_16bIdSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB0_16B_ID to value 0"]
impl crate::Resettable for Mb16bGroupMb0_16bIdSpec {}
