#[doc = "Register `MB11_32B_WORD7` reader"]
pub type R = crate::R<Mb32bGroupMb11_32bWord7Spec>;
#[doc = "Register `MB11_32B_WORD7` writer"]
pub type W = crate::W<Mb32bGroupMb11_32bWord7Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_31(&mut self) -> DataByte31W<Mb32bGroupMb11_32bWord7Spec> {
        DataByte31W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_30(&mut self) -> DataByte30W<Mb32bGroupMb11_32bWord7Spec> {
        DataByte30W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_29(&mut self) -> DataByte29W<Mb32bGroupMb11_32bWord7Spec> {
        DataByte29W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_28(&mut self) -> DataByte28W<Mb32bGroupMb11_32bWord7Spec> {
...
pub struct Mb32bGroupMb11_32bWord7Spec;
impl crate::RegisterSpec for Mb32bGroupMb11_32bWord7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_32b_group_mb11_32b_word7::R`](R) reader structure"]
impl crate::Readable for Mb32bGroupMb11_32bWord7Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_32b_group_mb11_32b_word7::W`](W) writer structure"]
impl crate::Writable for Mb32bGroupMb11_32bWord7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB11_32B_WORD7 to value 0"]
impl crate::Resettable for Mb32bGroupMb11_32bWord7Spec {}
