#[doc = "Register `MB5_64B_WORD8` reader"]
pub type R = crate::R<Mb64bGroupMb5_64bWord8Spec>;
#[doc = "Register `MB5_64B_WORD8` writer"]
pub type W = crate::W<Mb64bGroupMb5_64bWord8Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_35(&mut self) -> DataByte35W<Mb64bGroupMb5_64bWord8Spec> {
        DataByte35W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_34(&mut self) -> DataByte34W<Mb64bGroupMb5_64bWord8Spec> {
        DataByte34W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_33(&mut self) -> DataByte33W<Mb64bGroupMb5_64bWord8Spec> {
        DataByte33W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_32(&mut self) -> DataByte32W<Mb64bGroupMb5_64bWord8Spec> {
...
pub struct Mb64bGroupMb5_64bWord8Spec;
impl crate::RegisterSpec for Mb64bGroupMb5_64bWord8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb5_64b_word8::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb5_64bWord8Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb5_64b_word8::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb5_64bWord8Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB5_64B_WORD8 to value 0"]
impl crate::Resettable for Mb64bGroupMb5_64bWord8Spec {}
