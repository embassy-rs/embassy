...
pub type R = crate::R<MbGroupId18Spec>;
#[doc = "Register `ID18` writer"]
pub type W = crate::W<MbGroupId18Spec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<MbGroupId18Spec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<MbGroupId18Spec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<MbGroupId18Spec> {
        PrioW::new(self, 29)
    }
}
...
pub struct MbGroupId18Spec;
impl crate::RegisterSpec for MbGroupId18Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_id18::R`](R) reader structure"]
impl crate::Readable for MbGroupId18Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_id18::W`](W) writer structure"]
impl crate::Writable for MbGroupId18Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ID18 to value 0"]
impl crate::Resettable for MbGroupId18Spec {}
