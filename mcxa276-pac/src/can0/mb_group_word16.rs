...
pub type R = crate::R<MbGroupWord16Spec>;
#[doc = "Register `WORD16` writer"]
pub type W = crate::W<MbGroupWord16Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<MbGroupWord16Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<MbGroupWord16Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<MbGroupWord16Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<MbGroupWord16Spec> {
...
pub struct MbGroupWord16Spec;
impl crate::RegisterSpec for MbGroupWord16Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_word16::R`](R) reader structure"]
impl crate::Readable for MbGroupWord16Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_word16::W`](W) writer structure"]
impl crate::Writable for MbGroupWord16Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD16 to value 0"]
impl crate::Resettable for MbGroupWord16Spec {}
