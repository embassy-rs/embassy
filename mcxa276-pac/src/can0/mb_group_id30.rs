...
pub type R = crate::R<MbGroupId30Spec>;
#[doc = "Register `ID30` writer"]
pub type W = crate::W<MbGroupId30Spec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<MbGroupId30Spec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<MbGroupId30Spec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<MbGroupId30Spec> {
        PrioW::new(self, 29)
    }
}
...
pub struct MbGroupId30Spec;
impl crate::RegisterSpec for MbGroupId30Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_group_id30::R`](R) reader structure"]
impl crate::Readable for MbGroupId30Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_group_id30::W`](W) writer structure"]
impl crate::Writable for MbGroupId30Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ID30 to value 0"]
impl crate::Resettable for MbGroupId30Spec {}
