#[doc = "Register `MB4_64B_WORD9` reader"]
pub type R = crate::R<Mb64bGroupMb4_64bWord9Spec>;
#[doc = "Register `MB4_64B_WORD9` writer"]
pub type W = crate::W<Mb64bGroupMb4_64bWord9Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_39(&mut self) -> DataByte39W<Mb64bGroupMb4_64bWord9Spec> {
        DataByte39W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_38(&mut self) -> DataByte38W<Mb64bGroupMb4_64bWord9Spec> {
        DataByte38W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_37(&mut self) -> DataByte37W<Mb64bGroupMb4_64bWord9Spec> {
        DataByte37W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_36(&mut self) -> DataByte36W<Mb64bGroupMb4_64bWord9Spec> {
...
pub struct Mb64bGroupMb4_64bWord9Spec;
impl crate::RegisterSpec for Mb64bGroupMb4_64bWord9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb_64b_group_mb4_64b_word9::R`](R) reader structure"]
impl crate::Readable for Mb64bGroupMb4_64bWord9Spec {}
#[doc = "`write(|w| ..)` method takes [`mb_64b_group_mb4_64b_word9::W`](W) writer structure"]
impl crate::Writable for Mb64bGroupMb4_64bWord9Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB4_64B_WORD9 to value 0"]
impl crate::Resettable for Mb64bGroupMb4_64bWord9Spec {}
