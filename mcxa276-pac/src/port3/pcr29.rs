...
impl W {
    ...
    #[doc = "Bit 2 - Pull Value"]
    #[inline(always)]
    pub fn pv(&mut self) -> PvW<Pcr29Spec> {
        PvW::new(self, 2)
    }
    #[doc = "Bit 3 - Slew Rate Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - Open Drain Enable"]
    #[inline(always)]
    pub fn ode(&mut self) -> OdeW<Pcr29Spec> {
        OdeW::new(self, 5)
    }
    #[doc = "Bit 6 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse(&mut self) -> DseW<Pcr29Spec> {
        DseW::new(self, 6)
    }
    #[doc = "Bits 8:11 - Pin Multiplex Control"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Input Buffer Enable"]
    #[inline(always)]
    pub fn ibe(&mut self) -> IbeW<Pcr29Spec> {
        IbeW::new(self, 12)
    }
    #[doc = "Bit 13 - Invert Input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<Pcr29Spec> {
        InvW::new(self, 13)
    }
    #[doc = "Bit 15 - Lock Register"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<Pcr29Spec> {
        LkW::new(self, 15)
    }
}
...
#[doc = "`reset()` method sets PCR29 to value 0x1103"]
impl crate::Resettable for Pcr29Spec {
    const RESET_VALUE: u32 = 0x1103;
}
