...
impl W {
    ...
    #[doc = "Bit 4 - Passive Filter Enable"]
    #[inline(always)]
    pub fn pfe(&mut self) -> PfeW<Pcr0Spec> {
        PfeW::new(self, 4)
    }
    #[doc = "Bit 5 - Open Drain Enable"]
    #[inline(always)]
    pub fn ode(&mut self) -> OdeW<Pcr0Spec> {
        OdeW::new(self, 5)
    }
    #[doc = "Bit 6 - Drive Strength Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse1(&mut self) -> Dse1W<Pcr0Spec> {
        Dse1W::new(self, 7)
    }
    #[doc = "Bits 8:11 - Pin Multiplex Control"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Input Buffer Enable"]
    #[inline(always)]
    pub fn ibe(&mut self) -> IbeW<Pcr0Spec> {
        IbeW::new(self, 12)
    }
    #[doc = "Bit 13 - Invert Input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<Pcr0Spec> {
        InvW::new(self, 13)
    }
    #[doc = "Bit 15 - Lock Register"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<Pcr0Spec> {
        LkW::new(self, 15)
    }
}
