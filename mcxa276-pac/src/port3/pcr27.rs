...
impl W {
    #[doc = "Bit 0 - Pull Select"]
    #[inline(always)]
    pub fn ps(&mut self) -> PsW<Pcr27Spec> {
        PsW::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Enable"]
    #[inline(always)]
    pub fn pe(&mut self) -> PeW<Pcr27Spec> {
        PeW::new(self, 1)
    }
    #[doc = "Bit 3 - Slew Rate Enable"]
    #[inline(always)]
    pub fn sre(&mut self) -> SreW<Pcr27Spec> {
        SreW::new(self, 3)
    }
    #[doc = "Bit 5 - Open Drain Enable"]
    #[inline(always)]
    pub fn ode(&mut self) -> OdeW<Pcr27Spec> {
        OdeW::new(self, 5)
    }
    #[doc = "Bit 6 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse(&mut self) -> DseW<Pcr27Spec> {
        DseW::new(self, 6)
    }
    #[doc = "Bit 7 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse1(&mut self) -> Dse1W<Pcr27Spec> {
        Dse1W::new(self, 7)
    }
    #[doc = "Bits 8:11 - Pin Multiplex Control"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Input Buffer Enable"]
    #[inline(always)]
    pub fn ibe(&mut self) -> IbeW<Pcr27Spec> {
        IbeW::new(self, 12)
    }
    #[doc = "Bit 13 - Invert Input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<Pcr27Spec> {
        InvW::new(self, 13)
    }
    #[doc = "Bit 15 - Lock Register"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<Pcr27Spec> {
        LkW::new(self, 15)
    }
}
