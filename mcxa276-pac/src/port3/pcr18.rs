...
impl W {
    ...
    #[doc = "Bit 2 - Pull Value"]
    #[inline(always)]
    pub fn pv(&mut self) -> PvW<Pcr18Spec> {
        PvW::new(self, 2)
    }
    #[doc = "Bit 3 - Slew Rate Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - Open Drain Enable"]
    #[inline(always)]
    pub fn ode(&mut self) -> OdeW<Pcr18Spec> {
        OdeW::new(self, 5)
    }
    #[doc = "Bit 6 - Drive Strength Enable"]
    #[inline(always)]
    pub fn dse(&mut self) -> DseW<Pcr18Spec> {
        DseW::new(self, 6)
    }
    #[doc = "Bits 8:11 - Pin Multiplex Control"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Input Buffer Enable"]
    #[inline(always)]
    pub fn ibe(&mut self) -> IbeW<Pcr18Spec> {
        IbeW::new(self, 12)
    }
    #[doc = "Bit 13 - Invert Input"]
    #[inline(always)]
    pub fn inv(&mut self) -> InvW<Pcr18Spec> {
        InvW::new(self, 13)
    }
    #[doc = "Bit 15 - Lock Register"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<Pcr18Spec> {
        LkW::new(self, 15)
    }
}
