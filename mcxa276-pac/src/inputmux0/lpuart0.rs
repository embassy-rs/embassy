...
pub type R = crate::R<Lpuart0Spec>;
#[doc = "Register `LPUART0` writer"]
pub type W = crate::W<Lpuart0Spec>;
...
#[doc = "Field `INP` reader - LPUART0 trigger input connections"]
...
#[doc = "Field `INP` writer - LPUART0 trigger input connections"]
...
impl R {
    #[doc = "Bits 0:5 - LPUART0 trigger input connections"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - LPUART0 trigger input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Lpuart0Spec> {
        InpW::new(self, 0)
    }
}
...
pub struct Lpuart0Spec;
impl crate::RegisterSpec for Lpuart0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpuart0::R`](R) reader structure"]
impl crate::Readable for Lpuart0Spec {}
#[doc = "`write(|w| ..)` method takes [`lpuart0::W`](W) writer structure"]
impl crate::Writable for Lpuart0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LPUART0 to value 0x3f"]
impl crate::Resettable for Lpuart0Spec {
