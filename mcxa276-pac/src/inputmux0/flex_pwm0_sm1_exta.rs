#[doc = "Register `FlexPWM0_SM1_EXTA` reader"]
pub type R = crate::R<FlexPwm0Sm1ExtaSpec>;
#[doc = "Register `FlexPWM0_SM1_EXTA` writer"]
pub type W = crate::W<FlexPwm0Sm1ExtaSpec>;
...
impl W {
    #[doc = "Bits 0:5 - EXTA input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm0Sm1ExtaSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm0Sm1ExtaSpec;
impl crate::RegisterSpec for FlexPwm0Sm1ExtaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm0_sm1_exta::R`](R) reader structure"]
impl crate::Readable for FlexPwm0Sm1ExtaSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm0_sm1_exta::W`](W) writer structure"]
impl crate::Writable for FlexPwm0Sm1ExtaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM0_SM1_EXTA to value 0x3f"]
impl crate::Resettable for FlexPwm0Sm1ExtaSpec {
