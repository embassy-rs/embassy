#[doc = "Register `FlexPWM1_SM3_EXTSYNC` reader"]
pub type R = crate::R<FlexPwm1Sm3ExtsyncSpec>;
#[doc = "Register `FlexPWM1_SM3_EXTSYNC` writer"]
pub type W = crate::W<FlexPwm1Sm3ExtsyncSpec>;
...
pub enum Trigin {
    ...
    Val53 = 53,
    #[doc = "54: PWM0_SM0_MUX_TRIG0 input is selected"]
    Val54 = 54,
    #[doc = "55: PWM0_SM0_MUX_TRIG1 input is selected"]
    Val55 = 55,
    #[doc = "56: PWM0_SM1_MUX_TRIG0 input is selected"]
    Val56 = 56,
    #[doc = "57: PWM0_SM1_MUX_TRIG1 input is selected"]
    Val57 = 57,
    #[doc = "58: PWM0_SM2_MUX_TRIG0 input is selected"]
    Val58 = 58,
    #[doc = "59: PWM0_SM2_MUX_TRIG1 input is selected"]
    Val59 = 59,
    #[doc = "60: PWM0_SM3_MUX_TRIG0 input is selected"]
    Val60 = 60,
    #[doc = "61: PWM0_SM3_MUX_TRIG1 input is selected"]
    Val61 = 61,
}
...
#[doc = "Field `TRIGIN` reader - EXTSYNC input connections for PWM0"]
...
#[doc = "Field `TRIGIN` writer - EXTSYNC input connections for PWM0"]
...
impl R {
    #[doc = "Bits 0:5 - EXTSYNC input connections for PWM0"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - EXTSYNC input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm1Sm3ExtsyncSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm1Sm3ExtsyncSpec;
impl crate::RegisterSpec for FlexPwm1Sm3ExtsyncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm1_sm3_extsync::R`](R) reader structure"]
impl crate::Readable for FlexPwm1Sm3ExtsyncSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm1_sm3_extsync::W`](W) writer structure"]
impl crate::Writable for FlexPwm1Sm3ExtsyncSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM1_SM3_EXTSYNC to value 0x3f"]
impl crate::Resettable for FlexPwm1Sm3ExtsyncSpec {
