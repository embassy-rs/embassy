#[doc = "Register `CTIMER3CAP[%s]` reader"]
pub type R = crate::R<Ctimer3capSpec>;
#[doc = "Register `CTIMER3CAP[%s]` writer"]
pub type W = crate::W<Ctimer3capSpec>;
...
impl W {
    #[doc = "Bits 0:6 - Input number for CTIMER3"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Ctimer3capSpec> {
        InpW::new(self, 0)
    }
}
...
pub struct Ctimer3capSpec;
impl crate::RegisterSpec for Ctimer3capSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimer3cap::R`](R) reader structure"]
impl crate::Readable for Ctimer3capSpec {}
#[doc = "`write(|w| ..)` method takes [`ctimer3cap::W`](W) writer structure"]
impl crate::Writable for Ctimer3capSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CTIMER3CAP[%s] to value 0x7f"]
impl crate::Resettable for Ctimer3capSpec {
