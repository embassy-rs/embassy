#[doc = "Register `QDC1_PHASEA` reader"]
pub type R = crate::R<Qdc1PhaseaSpec>;
#[doc = "Register `QDC1_PHASEA` writer"]
pub type W = crate::W<Qdc1PhaseaSpec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC0 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc1PhaseaSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC1 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc1_phasea::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc1_phasea::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc1PhaseaSpec;
impl crate::RegisterSpec for Qdc1PhaseaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc1_phasea::R`](R) reader structure"]
impl crate::Readable for Qdc1PhaseaSpec {}
#[doc = "`write(|w| ..)` method takes [`qdc1_phasea::W`](W) writer structure"]
impl crate::Writable for Qdc1PhaseaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC1_PHASEA to value 0x7f"]
impl crate::Resettable for Qdc1PhaseaSpec {
