#[doc = "Register `LPSPI1_TRIG` reader"]
pub type R = crate::R<Lpspi1TrigSpec>;
#[doc = "Register `LPSPI1_TRIG` writer"]
pub type W = crate::W<Lpspi1TrigSpec>;
...
#[doc = "Field `INP` reader - LPSPI1 trigger input connections"]
...
#[doc = "Field `INP` writer - LPSPI1 trigger input connections"]
...
impl R {
    #[doc = "Bits 0:5 - LPSPI1 trigger input connections"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - LPSPI1 trigger input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Lpspi1TrigSpec> {
        InpW::new(self, 0)
    }
}
...
pub struct Lpspi1TrigSpec;
impl crate::RegisterSpec for Lpspi1TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpspi1_trig::R`](R) reader structure"]
impl crate::Readable for Lpspi1TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`lpspi1_trig::W`](W) writer structure"]
impl crate::Writable for Lpspi1TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LPSPI1_TRIG to value 0x3f"]
impl crate::Resettable for Lpspi1TrigSpec {
