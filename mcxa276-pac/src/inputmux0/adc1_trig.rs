#[doc = "Register `ADC1_TRIG[%s]` reader"]
pub type R = crate::R<Adc1TrigSpec>;
#[doc = "Register `ADC1_TRIG[%s]` writer"]
pub type W = crate::W<Adc1TrigSpec>;
...
pub enum Trigin {
    ...
    Val38 = 38,
    #[doc = "39: ADC0_tcomp\\[2\\] input is selected"]
    Val39 = 39,
    #[doc = "40: ADC0_tcomp\\[3\\] input is selected"]
    Val40 = 40,
...
#[doc = "Field `TRIGIN` reader - ADC1 trigger inputs"]
...
#[doc = "Field `TRIGIN` writer - ADC1 trigger inputs"]
...
impl R {
    #[doc = "Bits 0:5 - ADC1 trigger inputs"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - ADC1 trigger inputs"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<Adc1TrigSpec> {
        TriginW::new(self, 0)
    }
}
#[doc = "ADC Trigger input connections\n\nYou can [`read`](crate::Reg::read) this register and get [`adc1_trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc1_trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc1TrigSpec;
impl crate::RegisterSpec for Adc1TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc1_trig::R`](R) reader structure"]
impl crate::Readable for Adc1TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`adc1_trig::W`](W) writer structure"]
impl crate::Writable for Adc1TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC1_TRIG[%s] to value 0x3f"]
impl crate::Resettable for Adc1TrigSpec {
