#[doc = "Register `QDC0_ICAP2` reader"]
pub type R = crate::R<Qdc0Icap2Spec>;
#[doc = "Register `QDC0_ICAP2` writer"]
pub type W = crate::W<Qdc0Icap2Spec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC0 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc0Icap2Spec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC0 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc0_icap2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc0_icap2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc0Icap2Spec;
impl crate::RegisterSpec for Qdc0Icap2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc0_icap2::R`](R) reader structure"]
impl crate::Readable for Qdc0Icap2Spec {}
#[doc = "`write(|w| ..)` method takes [`qdc0_icap2::W`](W) writer structure"]
impl crate::Writable for Qdc0Icap2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC0_ICAP2 to value 0x7f"]
impl crate::Resettable for Qdc0Icap2Spec {
