#[doc = "Register `QDC1_ICAP2` reader"]
pub type R = crate::R<Qdc1Icap2Spec>;
#[doc = "Register `QDC1_ICAP2` writer"]
pub type W = crate::W<Qdc1Icap2Spec>;
...
pub enum Inp {
    ...
    Val68 = 68,
    #[doc = "69: PWM1_SM3_MUX_TRIG1 input is selected"]
    Val69 = 69,
}
...
impl W {
    #[doc = "Bits 0:6 - QDC1 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc1Icap2Spec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC1 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc1_icap2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc1_icap2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc1Icap2Spec;
impl crate::RegisterSpec for Qdc1Icap2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc1_icap2::R`](R) reader structure"]
impl crate::Readable for Qdc1Icap2Spec {}
#[doc = "`write(|w| ..)` method takes [`qdc1_icap2::W`](W) writer structure"]
impl crate::Writable for Qdc1Icap2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC1_ICAP2 to value 0x7f"]
impl crate::Resettable for Qdc1Icap2Spec {
