#[doc = "Register `TIMER4TRIG` reader"]
pub type R = crate::R<Timer4trigSpec>;
#[doc = "Register `TIMER4TRIG` writer"]
pub type W = crate::W<Timer4trigSpec>;
...
impl W {
    #[doc = "Bits 0:6 - Input number for CTIMER4"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Timer4trigSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "Trigger register for TIMER4\n\nYou can [`read`](crate::Reg::read) this register and get [`timer4trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer4trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timer4trigSpec;
impl crate::RegisterSpec for Timer4trigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer4trig::R`](R) reader structure"]
impl crate::Readable for Timer4trigSpec {}
#[doc = "`write(|w| ..)` method takes [`timer4trig::W`](W) writer structure"]
impl crate::Writable for Timer4trigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMER4TRIG to value 0x7f"]
impl crate::Resettable for Timer4trigSpec {
