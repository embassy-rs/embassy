#[doc = "Register `TIMER2TRIG` reader"]
pub type R = crate::R<Timer2trigSpec>;
#[doc = "Register `TIMER2TRIG` writer"]
pub type W = crate::W<Timer2trigSpec>;
...
#[doc = "Field `INP` reader - Input number for CTIMER2"]
...
#[doc = "Field `INP` writer - Input number for CTIMER2"]
...
impl R {
    #[doc = "Bits 0:6 - Input number for CTIMER2"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:6 - Input number for CTIMER2"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Timer2trigSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "Trigger register for TIMER2 inputs\n\nYou can [`read`](crate::Reg::read) this register and get [`timer2trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer2trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timer2trigSpec;
impl crate::RegisterSpec for Timer2trigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer2trig::R`](R) reader structure"]
impl crate::Readable for Timer2trigSpec {}
#[doc = "`write(|w| ..)` method takes [`timer2trig::W`](W) writer structure"]
impl crate::Writable for Timer2trigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMER2TRIG to value 0x7f"]
impl crate::Resettable for Timer2trigSpec {
