#[doc = "Register `FlexPWM0_SM3_EXTA0` reader"]
pub type R = crate::R<FlexPwm0Sm3Exta0Spec>;
#[doc = "Register `FlexPWM0_SM3_EXTA0` writer"]
pub type W = crate::W<FlexPwm0Sm3Exta0Spec>;
...
impl W {
    #[doc = "Bits 0:5 - EXTA input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm0Sm3Exta0Spec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm0Sm3Exta0Spec;
impl crate::RegisterSpec for FlexPwm0Sm3Exta0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm0_sm3_exta0::R`](R) reader structure"]
impl crate::Readable for FlexPwm0Sm3Exta0Spec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm0_sm3_exta0::W`](W) writer structure"]
impl crate::Writable for FlexPwm0Sm3Exta0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM0_SM3_EXTA0 to value 0x3f"]
impl crate::Resettable for FlexPwm0Sm3Exta0Spec {
