#[doc = "Register `ADC0_TRIG[%s]` reader"]
pub type R = crate::R<Adc0TrigSpec>;
#[doc = "Register `ADC0_TRIG[%s]` writer"]
pub type W = crate::W<Adc0TrigSpec>;
...
pub enum Trigin {
    ...
    Val36 = 36,
    #[doc = "37: ADC1_tcomp\\[0\\] input is selected"]
    Val37 = 37,
    #[doc = "38: ADC1_tcomp\\[1\\] input is selected"]
    Val38 = 38,
    #[doc = "39: ADC1_tcomp\\[2\\] input is selected"]
    Val39 = 39,
    #[doc = "40: ADC1_tcomp\\[3\\] input is selected"]
    Val40 = 40,
...
#[doc = "Field `TRIGIN` reader - ADC0 trigger inputs"]
...
#[doc = "Field `TRIGIN` writer - ADC0 trigger inputs"]
...
impl R {
    #[doc = "Bits 0:5 - ADC0 trigger inputs"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - ADC0 trigger inputs"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<Adc0TrigSpec> {
        TriginW::new(self, 0)
    }
}
#[doc = "ADC Trigger input connections\n\nYou can [`read`](crate::Reg::read) this register and get [`adc0_trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc0_trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc0TrigSpec;
impl crate::RegisterSpec for Adc0TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc0_trig::R`](R) reader structure"]
impl crate::Readable for Adc0TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`adc0_trig::W`](W) writer structure"]
impl crate::Writable for Adc0TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC0_TRIG[%s] to value 0x3f"]
impl crate::Resettable for Adc0TrigSpec {
