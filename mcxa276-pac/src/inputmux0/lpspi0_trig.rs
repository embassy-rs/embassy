#[doc = "Register `LPSPI0_TRIG` reader"]
pub type R = crate::R<Lpspi0TrigSpec>;
#[doc = "Register `LPSPI0_TRIG` writer"]
pub type W = crate::W<Lpspi0TrigSpec>;
...
pub enum Inp {
    ...
    Val10 = 10,
    #[doc = "11: CTimer1_MAT1 input is selected"]
    Val11 = 11,
    #[doc = "12: CTimer1_MAT2 input is selected"]
    Val12 = 12,
    #[doc = "13: CTimer2_MAT1 input is selected"]
    Val13 = 13,
    #[doc = "14: CTimer2_MAT2 input is selected"]
    Val14 = 14,
...
#[doc = "Field `INP` reader - LPSPI0 trigger input connections"]
...
#[doc = "Field `INP` writer - LPSPI0 trigger input connections"]
...
impl R {
    #[doc = "Bits 0:5 - LPSPI0 trigger input connections"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - LPSPI0 trigger input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Lpspi0TrigSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "LPSPI0 trigger input connections\n\nYou can [`read`](crate::Reg::read) this register and get [`lpspi0_trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpspi0_trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lpspi0TrigSpec;
impl crate::RegisterSpec for Lpspi0TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpspi0_trig::R`](R) reader structure"]
impl crate::Readable for Lpspi0TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`lpspi0_trig::W`](W) writer structure"]
impl crate::Writable for Lpspi0TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LPSPI0_TRIG to value 0x3f"]
impl crate::Resettable for Lpspi0TrigSpec {
