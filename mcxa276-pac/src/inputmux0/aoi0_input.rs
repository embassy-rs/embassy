#[doc = "Register `AOI0_INPUT[%s]` reader"]
pub type R = crate::R<Aoi0InputSpec>;
#[doc = "Register `AOI0_INPUT[%s]` writer"]
pub type W = crate::W<Aoi0InputSpec>;
...
pub enum Inp {
    ...
    Val11 = 11,
    #[doc = "12: CTimer1_MAT0 input is selected"]
    Val12 = 12,
    ...
    Val26 = 26,
    #[doc = "27: PWM0_SM0_MUX_TRIG0 0 input is selected"]
    Val27 = 27,
...
impl W {
    #[doc = "Bits 0:6 - AOI0 trigger input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Aoi0InputSpec> {
        InpW::new(self, 0)
    }
}
...
pub struct Aoi0InputSpec;
impl crate::RegisterSpec for Aoi0InputSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aoi0_input::R`](R) reader structure"]
impl crate::Readable for Aoi0InputSpec {}
#[doc = "`write(|w| ..)` method takes [`aoi0_input::W`](W) writer structure"]
impl crate::Writable for Aoi0InputSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AOI0_INPUT[%s] to value 0x7f"]
impl crate::Resettable for Aoi0InputSpec {
