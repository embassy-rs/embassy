#[doc = "Register `CMP0_TRIG` reader"]
pub type R = crate::R<Cmp0TrigSpec>;
#[doc = "Register `CMP0_TRIG` writer"]
pub type W = crate::W<Cmp0TrigSpec>;
...
#[doc = "Field `TRIGIN` reader - CMP0 input trigger"]
...
#[doc = "Field `TRIGIN` writer - CMP0 input trigger"]
...
impl R {
    #[doc = "Bits 0:5 - CMP0 input trigger"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - CMP0 input trigger"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<Cmp0TrigSpec> {
        TriginW::new(self, 0)
    }
}
#[doc = "CMP0 input connections\n\nYou can [`read`](crate::Reg::read) this register and get [`cmp0_trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmp0_trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmp0TrigSpec;
impl crate::RegisterSpec for Cmp0TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmp0_trig::R`](R) reader structure"]
impl crate::Readable for Cmp0TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`cmp0_trig::W`](W) writer structure"]
impl crate::Writable for Cmp0TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CMP0_TRIG to value 0x3f"]
impl crate::Resettable for Cmp0TrigSpec {
