#[doc = "Register `FlexPWM0_FAULT[%s]` reader"]
pub type R = crate::R<FlexPwm0FaultSpec>;
#[doc = "Register `FlexPWM0_FAULT[%s]` writer"]
pub type W = crate::W<FlexPwm0FaultSpec>;
...
#[doc = "Field `TRIGIN` reader - FAULT input connections for PWM0"]
...
#[doc = "Field `TRIGIN` writer - FAULT input connections for PWM0"]
...
impl R {
    #[doc = "Bits 0:5 - FAULT input connections for PWM0"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - FAULT input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm0FaultSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm0FaultSpec;
impl crate::RegisterSpec for FlexPwm0FaultSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm0_fault::R`](R) reader structure"]
impl crate::Readable for FlexPwm0FaultSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm0_fault::W`](W) writer structure"]
impl crate::Writable for FlexPwm0FaultSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM0_FAULT[%s] to value 0x3f"]
impl crate::Resettable for FlexPwm0FaultSpec {
