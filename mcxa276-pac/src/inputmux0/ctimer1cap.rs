#[doc = "Register `CTIMER1CAP[%s]` reader"]
pub type R = crate::R<Ctimer1capSpec>;
#[doc = "Register `CTIMER1CAP[%s]` writer"]
pub type W = crate::W<Ctimer1capSpec>;
...
#[doc = "Field `INP` reader - Input number for CTIMER1"]
...
#[doc = "Field `INP` writer - Input number for CTIMER1"]
...
impl R {
    #[doc = "Bits 0:6 - Input number for CTIMER1"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:6 - Input number for CTIMER1"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Ctimer1capSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "Capture select register for CTIMER inputs\n\nYou can [`read`](crate::Reg::read) this register and get [`ctimer1cap::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctimer1cap::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ctimer1capSpec;
impl crate::RegisterSpec for Ctimer1capSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimer1cap::R`](R) reader structure"]
impl crate::Readable for Ctimer1capSpec {}
#[doc = "`write(|w| ..)` method takes [`ctimer1cap::W`](W) writer structure"]
impl crate::Writable for Ctimer1capSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CTIMER1CAP[%s] to value 0x7f"]
impl crate::Resettable for Ctimer1capSpec {
