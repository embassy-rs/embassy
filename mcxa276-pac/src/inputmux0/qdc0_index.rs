#[doc = "Register `QDC0_INDEX` reader"]
pub type R = crate::R<Qdc0IndexSpec>;
#[doc = "Register `QDC0_INDEX` writer"]
pub type W = crate::W<Qdc0IndexSpec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC0 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc0IndexSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC0 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc0_index::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc0_index::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc0IndexSpec;
impl crate::RegisterSpec for Qdc0IndexSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc0_index::R`](R) reader structure"]
impl crate::Readable for Qdc0IndexSpec {}
#[doc = "`write(|w| ..)` method takes [`qdc0_index::W`](W) writer structure"]
impl crate::Writable for Qdc0IndexSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC0_INDEX to value 0x7f"]
impl crate::Resettable for Qdc0IndexSpec {
