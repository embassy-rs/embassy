#[doc = "Register `QDC1_INDEX` reader"]
pub type R = crate::R<Qdc1IndexSpec>;
#[doc = "Register `QDC1_INDEX` writer"]
pub type W = crate::W<Qdc1IndexSpec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC1 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc1IndexSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC1 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc1_index::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc1_index::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc1IndexSpec;
impl crate::RegisterSpec for Qdc1IndexSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc1_index::R`](R) reader structure"]
impl crate::Readable for Qdc1IndexSpec {}
#[doc = "`write(|w| ..)` method takes [`qdc1_index::W`](W) writer structure"]
impl crate::Writable for Qdc1IndexSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC1_INDEX to value 0x7f"]
impl crate::Resettable for Qdc1IndexSpec {
