#[doc = "Register `FlexPWM0_SM0_EXTSYNC` reader"]
pub type R = crate::R<FlexPwm0Sm0ExtsyncSpec>;
#[doc = "Register `FlexPWM0_SM0_EXTSYNC` writer"]
pub type W = crate::W<FlexPwm0Sm0ExtsyncSpec>;
...
impl W {
    #[doc = "Bits 0:5 - EXTSYNC input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm0Sm0ExtsyncSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm0Sm0ExtsyncSpec;
impl crate::RegisterSpec for FlexPwm0Sm0ExtsyncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm0_sm0_extsync::R`](R) reader structure"]
impl crate::Readable for FlexPwm0Sm0ExtsyncSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm0_sm0_extsync::W`](W) writer structure"]
impl crate::Writable for FlexPwm0Sm0ExtsyncSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM0_SM0_EXTSYNC to value 0x3f"]
impl crate::Resettable for FlexPwm0Sm0ExtsyncSpec {
