#[doc = "Register `CTIMER0CAP[%s]` reader"]
pub type R = crate::R<Ctimer0capSpec>;
#[doc = "Register `CTIMER0CAP[%s]` writer"]
pub type W = crate::W<Ctimer0capSpec>;
...
pub enum Inp {
    ...
    Val92 = 92,
    #[doc = "93: PWM1_SM3_MUX_TRIG0 input is selected"]
    Val93 = 93,
...
impl W {
    #[doc = "Bits 0:6 - Input number for CTIMER0"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Ctimer0capSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "Capture select register for CTIMER inputs\n\nYou can [`read`](crate::Reg::read) this register and get [`ctimer0cap::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctimer0cap::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ctimer0capSpec;
impl crate::RegisterSpec for Ctimer0capSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimer0cap::R`](R) reader structure"]
impl crate::Readable for Ctimer0capSpec {}
#[doc = "`write(|w| ..)` method takes [`ctimer0cap::W`](W) writer structure"]
impl crate::Writable for Ctimer0capSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CTIMER0CAP[%s] to value 0x7f"]
impl crate::Resettable for Ctimer0capSpec {
