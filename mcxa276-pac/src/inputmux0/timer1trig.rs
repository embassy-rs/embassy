#[doc = "Register `TIMER1TRIG` reader"]
pub type R = crate::R<Timer1trigSpec>;
#[doc = "Register `TIMER1TRIG` writer"]
pub type W = crate::W<Timer1trigSpec>;
...
impl W {
    #[doc = "Bits 0:6 - Input number for CTIMER1"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Timer1trigSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "Trigger register for TIMER1\n\nYou can [`read`](crate::Reg::read) this register and get [`timer1trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer1trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timer1trigSpec;
impl crate::RegisterSpec for Timer1trigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer1trig::R`](R) reader structure"]
impl crate::Readable for Timer1trigSpec {}
#[doc = "`write(|w| ..)` method takes [`timer1trig::W`](W) writer structure"]
impl crate::Writable for Timer1trigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMER1TRIG to value 0x7f"]
impl crate::Resettable for Timer1trigSpec {
