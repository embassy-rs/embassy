#[doc = "Register `LPI2C1_TRIG` reader"]
pub type R = crate::R<Lpi2c1TrigSpec>;
#[doc = "Register `LPI2C1_TRIG` writer"]
pub type W = crate::W<Lpi2c1TrigSpec>;
...
#[doc = "Field `INP` reader - LPI2C1 trigger input connections"]
...
#[doc = "Field `INP` writer - LPI2C1 trigger input connections"]
...
impl R {
    #[doc = "Bits 0:5 - LPI2C1 trigger input connections"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - LPI2C1 trigger input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Lpi2c1TrigSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "LPI2C1 trigger input connections\n\nYou can [`read`](crate::Reg::read) this register and get [`lpi2c1_trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpi2c1_trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lpi2c1TrigSpec;
impl crate::RegisterSpec for Lpi2c1TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpi2c1_trig::R`](R) reader structure"]
impl crate::Readable for Lpi2c1TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`lpi2c1_trig::W`](W) writer structure"]
impl crate::Writable for Lpi2c1TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LPI2C1_TRIG to value 0x3f"]
impl crate::Resettable for Lpi2c1TrigSpec {
