#[doc = "Register `FlexPWM1_SM0_EXTA0` reader"]
pub type R = crate::R<FlexPwm1Sm0Exta0Spec>;
#[doc = "Register `FlexPWM1_SM0_EXTA0` writer"]
pub type W = crate::W<FlexPwm1Sm0Exta0Spec>;
...
impl W {
    #[doc = "Bits 0:5 - EXTA input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm1Sm0Exta0Spec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm1Sm0Exta0Spec;
impl crate::RegisterSpec for FlexPwm1Sm0Exta0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm1_sm0_exta0::R`](R) reader structure"]
impl crate::Readable for FlexPwm1Sm0Exta0Spec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm1_sm0_exta0::W`](W) writer structure"]
impl crate::Writable for FlexPwm1Sm0Exta0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM1_SM0_EXTA0 to value 0x3f"]
impl crate::Resettable for FlexPwm1Sm0Exta0Spec {
