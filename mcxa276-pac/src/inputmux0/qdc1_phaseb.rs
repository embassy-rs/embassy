#[doc = "Register `QDC1_PHASEB` reader"]
pub type R = crate::R<Qdc1PhasebSpec>;
#[doc = "Register `QDC1_PHASEB` writer"]
pub type W = crate::W<Qdc1PhasebSpec>;
...
pub enum Inp {
    ...
    Val68 = 68,
    #[doc = "69: PWM1_SM3_MUX_TRIG1 inout is selected"]
    Val69 = 69,
}
...
#[doc = "Field `INP` reader - QDC1 input connections"]
...
#[doc = "Field `INP` writer - QDC1 input connections"]
...
impl R {
    #[doc = "Bits 0:6 - QDC1 input connections"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:6 - QDC1 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc1PhasebSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC1 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc1_phaseb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc1_phaseb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc1PhasebSpec;
impl crate::RegisterSpec for Qdc1PhasebSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc1_phaseb::R`](R) reader structure"]
impl crate::Readable for Qdc1PhasebSpec {}
#[doc = "`write(|w| ..)` method takes [`qdc1_phaseb::W`](W) writer structure"]
impl crate::Writable for Qdc1PhasebSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC1_PHASEB to value 0x7f"]
impl crate::Resettable for Qdc1PhasebSpec {
