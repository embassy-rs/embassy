#[doc = "Register `CTIMER4CAP[%s]` reader"]
pub type R = crate::R<Ctimer4capSpec>;
#[doc = "Register `CTIMER4CAP[%s]` writer"]
pub type W = crate::W<Ctimer4capSpec>;
...
pub enum Inp {
    ...
    Val81 = 81,
    #[doc = "82: CTimer3_MAT1 input is selected"]
    Val82 = 82,
    #[doc = "83: CTimer3_MAT2 input is selected"]
    Val83 = 83,
    #[doc = "84: CTimer3_MAT3 input is selected"]
    Val84 = 84,
...
#[doc = "Field `INP` reader - Input number for CTIMER4"]
...
#[doc = "Field `INP` writer - Input number for CTIMER4"]
...
impl R {
    #[doc = "Bits 0:6 - Input number for CTIMER4"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:6 - Input number for CTIMER4"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Ctimer4capSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "Capture select register for CTIMER inputs\n\nYou can [`read`](crate::Reg::read) this register and get [`ctimer4cap::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctimer4cap::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ctimer4capSpec;
impl crate::RegisterSpec for Ctimer4capSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimer4cap::R`](R) reader structure"]
impl crate::Readable for Ctimer4capSpec {}
#[doc = "`write(|w| ..)` method takes [`ctimer4cap::W`](W) writer structure"]
impl crate::Writable for Ctimer4capSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CTIMER4CAP[%s] to value 0x7f"]
impl crate::Resettable for Ctimer4capSpec {
