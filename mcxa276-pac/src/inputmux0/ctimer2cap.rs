#[doc = "Register `CTIMER2CAP[%s]` reader"]
pub type R = crate::R<Ctimer2capSpec>;
#[doc = "Register `CTIMER2CAP[%s]` writer"]
pub type W = crate::W<Ctimer2capSpec>;
...
impl W {
    #[doc = "Bits 0:6 - Input number for CTIMER2"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Ctimer2capSpec> {
        InpW::new(self, 0)
    }
}
...
pub struct Ctimer2capSpec;
impl crate::RegisterSpec for Ctimer2capSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimer2cap::R`](R) reader structure"]
impl crate::Readable for Ctimer2capSpec {}
#[doc = "`write(|w| ..)` method takes [`ctimer2cap::W`](W) writer structure"]
impl crate::Writable for Ctimer2capSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CTIMER2CAP[%s] to value 0x7f"]
impl crate::Resettable for Ctimer2capSpec {
