#[doc = "Register `QDC1_ICAP1` reader"]
pub type R = crate::R<Qdc1Icap1Spec>;
#[doc = "Register `QDC1_ICAP1` writer"]
pub type W = crate::W<Qdc1Icap1Spec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC1 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc1Icap1Spec> {
        InpW::new(self, 0)
    }
}
...
pub struct Qdc1Icap1Spec;
impl crate::RegisterSpec for Qdc1Icap1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc1_icap1::R`](R) reader structure"]
impl crate::Readable for Qdc1Icap1Spec {}
#[doc = "`write(|w| ..)` method takes [`qdc1_icap1::W`](W) writer structure"]
impl crate::Writable for Qdc1Icap1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC1_ICAP1 to value 0x7f"]
impl crate::Resettable for Qdc1Icap1Spec {
