#[doc = "Register `FlexPWM1_FORCE` reader"]
pub type R = crate::R<FlexPwm1ForceSpec>;
#[doc = "Register `FlexPWM1_FORCE` writer"]
pub type W = crate::W<FlexPwm1ForceSpec>;
...
#[doc = "Field `TRIGIN` reader - Trigger input connections for PWM1"]
...
#[doc = "Field `TRIGIN` writer - Trigger input connections for PWM1"]
...
impl R {
    #[doc = "Bits 0:5 - Trigger input connections for PWM1"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - Trigger input connections for PWM1"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm1ForceSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm1ForceSpec;
impl crate::RegisterSpec for FlexPwm1ForceSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm1_force::R`](R) reader structure"]
impl crate::Readable for FlexPwm1ForceSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm1_force::W`](W) writer structure"]
impl crate::Writable for FlexPwm1ForceSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM1_FORCE to value 0x3f"]
impl crate::Resettable for FlexPwm1ForceSpec {
