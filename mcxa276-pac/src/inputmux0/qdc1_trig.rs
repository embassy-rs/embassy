#[doc = "Register `QDC1_TRIG` reader"]
pub type R = crate::R<Qdc1TrigSpec>;
#[doc = "Register `QDC1_TRIG` writer"]
pub type W = crate::W<Qdc1TrigSpec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC1 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc1TrigSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC1 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc1_trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc1_trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc1TrigSpec;
impl crate::RegisterSpec for Qdc1TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc1_trig::R`](R) reader structure"]
impl crate::Readable for Qdc1TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`qdc1_trig::W`](W) writer structure"]
impl crate::Writable for Qdc1TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC1_TRIG to value 0x7f"]
impl crate::Resettable for Qdc1TrigSpec {
