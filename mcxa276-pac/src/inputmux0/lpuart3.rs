#[doc = "Register `LPUART3` reader"]
pub type R = crate::R<Lpuart3Spec>;
#[doc = "Register `LPUART3` writer"]
pub type W = crate::W<Lpuart3Spec>;
...
#[doc = "Field `INP` reader - LPUART3 trigger input connections"]
...
#[doc = "Field `INP` writer - LPUART3 trigger input connections"]
...
impl R {
    #[doc = "Bits 0:5 - LPUART3 trigger input connections"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - LPUART3 trigger input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Lpuart3Spec> {
        InpW::new(self, 0)
    }
}
#[doc = "LPUART3 trigger input connections\n\nYou can [`read`](crate::Reg::read) this register and get [`lpuart3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpuart3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lpuart3Spec;
impl crate::RegisterSpec for Lpuart3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpuart3::R`](R) reader structure"]
impl crate::Readable for Lpuart3Spec {}
#[doc = "`write(|w| ..)` method takes [`lpuart3::W`](W) writer structure"]
impl crate::Writable for Lpuart3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets LPUART3 to value 0x3f"]
impl crate::Resettable for Lpuart3Spec {
