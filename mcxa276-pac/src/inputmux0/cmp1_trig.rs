#[doc = "Register `CMP1_TRIG` reader"]
pub type R = crate::R<Cmp1TrigSpec>;
#[doc = "Register `CMP1_TRIG` writer"]
pub type W = crate::W<Cmp1TrigSpec>;
...
#[doc = "Field `TRIGIN` reader - CMP1 input trigger"]
...
#[doc = "Field `TRIGIN` writer - CMP1 input trigger"]
...
impl R {
    #[doc = "Bits 0:5 - CMP1 input trigger"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - CMP1 input trigger"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<Cmp1TrigSpec> {
        TriginW::new(self, 0)
    }
}
#[doc = "CMP1 input connections\n\nYou can [`read`](crate::Reg::read) this register and get [`cmp1_trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmp1_trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmp1TrigSpec;
impl crate::RegisterSpec for Cmp1TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmp1_trig::R`](R) reader structure"]
impl crate::Readable for Cmp1TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`cmp1_trig::W`](W) writer structure"]
impl crate::Writable for Cmp1TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CMP1_TRIG to value 0x3f"]
impl crate::Resettable for Cmp1TrigSpec {
