#[doc = "Register `PWM0_EXT_CLK` reader"]
pub type R = crate::R<Pwm0ExtClkSpec>;
#[doc = "Register `PWM0_EXT_CLK` writer"]
pub type W = crate::W<Pwm0ExtClkSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Trigger input connections for PWM"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<Pwm0ExtClkSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct Pwm0ExtClkSpec;
impl crate::RegisterSpec for Pwm0ExtClkSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pwm0_ext_clk::R`](R) reader structure"]
impl crate::Readable for Pwm0ExtClkSpec {}
#[doc = "`write(|w| ..)` method takes [`pwm0_ext_clk::W`](W) writer structure"]
impl crate::Writable for Pwm0ExtClkSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PWM0_EXT_CLK to value 0x0f"]
impl crate::Resettable for Pwm0ExtClkSpec {
