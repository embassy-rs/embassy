#[doc = "Register `QDC0_HOME` reader"]
pub type R = crate::R<Qdc0HomeSpec>;
#[doc = "Register `QDC0_HOME` writer"]
pub type W = crate::W<Qdc0HomeSpec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC0 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc0HomeSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC0 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc0_home::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc0_home::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc0HomeSpec;
impl crate::RegisterSpec for Qdc0HomeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc0_home::R`](R) reader structure"]
impl crate::Readable for Qdc0HomeSpec {}
#[doc = "`write(|w| ..)` method takes [`qdc0_home::W`](W) writer structure"]
impl crate::Writable for Qdc0HomeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC0_HOME to value 0x7f"]
impl crate::Resettable for Qdc0HomeSpec {
