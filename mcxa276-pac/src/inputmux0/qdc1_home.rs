#[doc = "Register `QDC1_HOME` reader"]
pub type R = crate::R<Qdc1HomeSpec>;
#[doc = "Register `QDC1_HOME` writer"]
pub type W = crate::W<Qdc1HomeSpec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC1 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc1HomeSpec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC1 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc1_home::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc1_home::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc1HomeSpec;
impl crate::RegisterSpec for Qdc1HomeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc1_home::R`](R) reader structure"]
impl crate::Readable for Qdc1HomeSpec {}
#[doc = "`write(|w| ..)` method takes [`qdc1_home::W`](W) writer structure"]
impl crate::Writable for Qdc1HomeSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC1_HOME to value 0x7f"]
impl crate::Resettable for Qdc1HomeSpec {
