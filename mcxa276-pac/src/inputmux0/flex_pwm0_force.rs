#[doc = "Register `FlexPWM0_FORCE` reader"]
pub type R = crate::R<FlexPwm0ForceSpec>;
#[doc = "Register `FlexPWM0_FORCE` writer"]
pub type W = crate::W<FlexPwm0ForceSpec>;
...
#[doc = "Field `TRIGIN` reader - Trigger input connections for PWM0"]
...
#[doc = "Field `TRIGIN` writer - Trigger input connections for PWM0"]
...
impl R {
    #[doc = "Bits 0:5 - Trigger input connections for PWM0"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - Trigger input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm0ForceSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm0ForceSpec;
impl crate::RegisterSpec for FlexPwm0ForceSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm0_force::R`](R) reader structure"]
impl crate::Readable for FlexPwm0ForceSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm0_force::W`](W) writer structure"]
impl crate::Writable for FlexPwm0ForceSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM0_FORCE to value 0x3f"]
impl crate::Resettable for FlexPwm0ForceSpec {
