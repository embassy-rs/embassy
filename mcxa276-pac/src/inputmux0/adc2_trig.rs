#[doc = "Register `ADC2_TRIG[%s]` reader"]
pub type R = crate::R<Adc2TrigSpec>;
#[doc = "Register `ADC2_TRIG[%s]` writer"]
pub type W = crate::W<Adc2TrigSpec>;
...
pub enum Trigin {
    ...
    Val15 = 15,
    #[doc = "17: QDC0_POS_MATCH0 input is selected"]
    Val17 = 17,
    #[doc = "18: PWM0_SM0_OUT_TRIG0 input is selected"]
    Val18 = 18,
    #[doc = "19: PWM0_SM0_OUT_TRIG1 input is selected"]
    Val19 = 19,
    #[doc = "20: PWM0_SM1_OUT_TRIG0 input is selected"]
    Val20 = 20,
    #[doc = "21: PWM0_SM1_OUT_TRIG1 input is selected"]
    Val21 = 21,
    #[doc = "22: PWM0_SM2_OUT_TRIG0 input is selected"]
    Val22 = 22,
    #[doc = "23: PWM0_SM2_OUT_TRIG1 input is selected"]
    Val23 = 23,
    #[doc = "24: PWM0_SM3_OUT_TRIG0 input is selected"]
    Val24 = 24,
    #[doc = "25: PWM0_SM3_OUT_TRIG1 input is selected"]
    Val25 = 25,
    ...
    Val36 = 36,
    #[doc = "37: ADC3_tcomp\\[0\\] input is selected"]
    Val37 = 37,
    #[doc = "38: ADC3_tcomp\\[1\\] input is selected"]
    Val38 = 38,
    #[doc = "39: ADC3_tcomp\\[2\\] input is selected"]
    Val39 = 39,
    #[doc = "40: ADC3_tcomp\\[3\\] input is selected"]
    Val40 = 40,
    ...
    Val48 = 48,
    #[doc = "49: QDC1_POS_MATCH0 input is selected"]
    Val49 = 49,
    ...
    Val55 = 55,
    #[doc = "56: PWM1_SM3_MUX_TRIG0 input is selected"]
    Val56 = 56,
    #[doc = "57: PWM1_SM3_MUX_TRIG1 input is selected"]
    Val57 = 57,
}
...
#[doc = "Field `TRIGIN` reader - ADC2 trigger inputs"]
...
#[doc = "Field `TRIGIN` writer - ADC2 trigger inputs"]
...
impl R {
    #[doc = "Bits 0:5 - ADC2 trigger inputs"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - ADC2 trigger inputs"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<Adc2TrigSpec> {
        TriginW::new(self, 0)
    }
}
#[doc = "ADC Trigger input connections\n\nYou can [`read`](crate::Reg::read) this register and get [`adc2_trig::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adc2_trig::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adc2TrigSpec;
impl crate::RegisterSpec for Adc2TrigSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adc2_trig::R`](R) reader structure"]
impl crate::Readable for Adc2TrigSpec {}
#[doc = "`write(|w| ..)` method takes [`adc2_trig::W`](W) writer structure"]
impl crate::Writable for Adc2TrigSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADC2_TRIG[%s] to value 0x3f"]
impl crate::Resettable for Adc2TrigSpec {
