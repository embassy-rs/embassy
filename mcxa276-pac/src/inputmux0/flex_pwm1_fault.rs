#[doc = "Register `FlexPWM1_FAULT[%s]` reader"]
pub type R = crate::R<FlexPwm1FaultSpec>;
#[doc = "Register `FlexPWM1_FAULT[%s]` writer"]
pub type W = crate::W<FlexPwm1FaultSpec>;
...
#[doc = "Field `TRIGIN` reader - FAULT input connections for PWM1"]
...
#[doc = "Field `TRIGIN` writer - FAULT input connections for PWM1"]
...
impl R {
    #[doc = "Bits 0:5 - FAULT input connections for PWM1"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:5 - FAULT input connections for PWM1"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm1FaultSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm1FaultSpec;
impl crate::RegisterSpec for FlexPwm1FaultSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm1_fault::R`](R) reader structure"]
impl crate::Readable for FlexPwm1FaultSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm1_fault::W`](W) writer structure"]
impl crate::Writable for FlexPwm1FaultSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM1_FAULT[%s] to value 0x3f"]
impl crate::Resettable for FlexPwm1FaultSpec {
