#[doc = "Register `FlexPWM1_SM2_EXTA` reader"]
pub type R = crate::R<FlexPwm1Sm2ExtaSpec>;
#[doc = "Register `FlexPWM1_SM2_EXTA` writer"]
pub type W = crate::W<FlexPwm1Sm2ExtaSpec>;
...
impl W {
    #[doc = "Bits 0:5 - EXTA input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm1Sm2ExtaSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm1Sm2ExtaSpec;
impl crate::RegisterSpec for FlexPwm1Sm2ExtaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm1_sm2_exta::R`](R) reader structure"]
impl crate::Readable for FlexPwm1Sm2ExtaSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm1_sm2_exta::W`](W) writer structure"]
impl crate::Writable for FlexPwm1Sm2ExtaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM1_SM2_EXTA to value 0x3f"]
impl crate::Resettable for FlexPwm1Sm2ExtaSpec {
