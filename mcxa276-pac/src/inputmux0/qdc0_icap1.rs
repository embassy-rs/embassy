#[doc = "Register `QDC0_ICAP1` reader"]
pub type R = crate::R<Qdc0Icap1Spec>;
#[doc = "Register `QDC0_ICAP1` writer"]
pub type W = crate::W<Qdc0Icap1Spec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC0 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc0Icap1Spec> {
        InpW::new(self, 0)
    }
}
#[doc = "QDC0 Trigger Input Connections\n\nYou can [`read`](crate::Reg::read) this register and get [`qdc0_icap1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`qdc0_icap1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Qdc0Icap1Spec;
impl crate::RegisterSpec for Qdc0Icap1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc0_icap1::R`](R) reader structure"]
impl crate::Readable for Qdc0Icap1Spec {}
#[doc = "`write(|w| ..)` method takes [`qdc0_icap1::W`](W) writer structure"]
impl crate::Writable for Qdc0Icap1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC0_ICAP1 to value 0x7f"]
impl crate::Resettable for Qdc0Icap1Spec {
