#[doc = "Register `QDC0_PHASEA` reader"]
pub type R = crate::R<Qdc0PhaseaSpec>;
#[doc = "Register `QDC0_PHASEA` writer"]
pub type W = crate::W<Qdc0PhaseaSpec>;
...
impl W {
    #[doc = "Bits 0:6 - QDC0 input connections"]
    #[inline(always)]
    pub fn inp(&mut self) -> InpW<Qdc0PhaseaSpec> {
        InpW::new(self, 0)
    }
}
...
pub struct Qdc0PhaseaSpec;
impl crate::RegisterSpec for Qdc0PhaseaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`qdc0_phasea::R`](R) reader structure"]
impl crate::Readable for Qdc0PhaseaSpec {}
#[doc = "`write(|w| ..)` method takes [`qdc0_phasea::W`](W) writer structure"]
impl crate::Writable for Qdc0PhaseaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets QDC0_PHASEA to value 0x7f"]
impl crate::Resettable for Qdc0PhaseaSpec {
