#[doc = "Register `FlexPWM1_SM0_EXTSYNC` reader"]
pub type R = crate::R<FlexPwm1Sm0ExtsyncSpec>;
#[doc = "Register `FlexPWM1_SM0_EXTSYNC` writer"]
pub type W = crate::W<FlexPwm1Sm0ExtsyncSpec>;
...
impl W {
    #[doc = "Bits 0:5 - EXTSYNC input connections for PWM0"]
    #[inline(always)]
    pub fn trigin(&mut self) -> TriginW<FlexPwm1Sm0ExtsyncSpec> {
        TriginW::new(self, 0)
    }
}
...
pub struct FlexPwm1Sm0ExtsyncSpec;
impl crate::RegisterSpec for FlexPwm1Sm0ExtsyncSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`flex_pwm1_sm0_extsync::R`](R) reader structure"]
impl crate::Readable for FlexPwm1Sm0ExtsyncSpec {}
#[doc = "`write(|w| ..)` method takes [`flex_pwm1_sm0_extsync::W`](W) writer structure"]
impl crate::Writable for FlexPwm1Sm0ExtsyncSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FlexPWM1_SM0_EXTSYNC to value 0x3f"]
impl crate::Resettable for FlexPwm1Sm0ExtsyncSpec {
