#[doc = "Register `PKC_XYPTR1` reader"]
pub type R = crate::R<PkcXyptr1Spec>;
#[doc = "Register `PKC_XYPTR1` writer"]
pub type W = crate::W<PkcXyptr1Spec>;
...
impl W {
    #[doc = "Bits 0:15 - Start address of X operand in PKCRAM with byte granularity"]
    #[inline(always)]
    pub fn xptr(&mut self) -> XptrW<PkcXyptr1Spec> {
        XptrW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Start address of Y operand in PKCRAM with byte granularity"]
    #[inline(always)]
    pub fn yptr(&mut self) -> YptrW<PkcXyptr1Spec> {
        YptrW::new(self, 16)
    }
}
...
pub struct PkcXyptr1Spec;
impl crate::RegisterSpec for PkcXyptr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pkc_xyptr1::R`](R) reader structure"]
impl crate::Readable for PkcXyptr1Spec {}
#[doc = "`write(|w| ..)` method takes [`pkc_xyptr1::W`](W) writer structure"]
impl crate::Writable for PkcXyptr1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PKC_XYPTR1 to value 0"]
impl crate::Resettable for PkcXyptr1Spec {}
