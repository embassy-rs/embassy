#[doc = "Register `PKC_ZRPTR1` reader"]
pub type R = crate::R<PkcZrptr1Spec>;
#[doc = "Register `PKC_ZRPTR1` writer"]
pub type W = crate::W<PkcZrptr1Spec>;
...
impl W {
    #[doc = "Bits 0:15 - Start address of Z operand in PKCRAM with byte granularity or constant for calculation modes using CONST"]
    #[inline(always)]
    pub fn zptr(&mut self) -> ZptrW<PkcZrptr1Spec> {
        ZptrW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Start address of R result in PKCRAM with byte granularity"]
    #[inline(always)]
    pub fn rptr(&mut self) -> RptrW<PkcZrptr1Spec> {
        RptrW::new(self, 16)
    }
}
#[doc = "Z+R pointer register, parameter set 1\n\nYou can [`read`](crate::Reg::read) this register and get [`pkc_zrptr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pkc_zrptr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PkcZrptr1Spec;
impl crate::RegisterSpec for PkcZrptr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pkc_zrptr1::R`](R) reader structure"]
impl crate::Readable for PkcZrptr1Spec {}
#[doc = "`write(|w| ..)` method takes [`pkc_zrptr1::W`](W) writer structure"]
impl crate::Writable for PkcZrptr1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PKC_ZRPTR1 to value 0"]
impl crate::Resettable for PkcZrptr1Spec {}
