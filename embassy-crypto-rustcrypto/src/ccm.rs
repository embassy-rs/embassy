//! CCM mode (NIST SP 800-38C, RFC 3610) over any AES encryptor.
//!
//! Written out rather than taken from the `ccm` crate, which is generic over
//! the tag and nonce sizes as type-level integers: supporting every combination
//! at runtime would instantiate it 49 times.
