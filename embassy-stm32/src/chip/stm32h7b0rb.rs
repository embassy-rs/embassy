...
peripherals!(
    ...
    EXTI13, EXTI14, EXTI15, ADC1, ADC2, BDMA1, BDMA2, COMP1, CRYP, DAC1, DAC2, DMA2D, DTS, FDCAN1,
    FDCAN2, GFXMMU, PA0, PA1, PA2, PA3, PA4, PA5, PA6, PA7, PA8, PA9, PA10, PA11, PA12, PA13, PA14,
    ...
    PE4, PE5, PE6, PE7, PE8, PE9, PE10, PE11, PE12, PE13, PE14, PE15, PF0, PF1, PF2, PF3, PF4, PF5,
    PF6, PF7, PF8, PF9, PF10, PF11, PF12, PF13, PF14, PF15, PG0, PG1, PG2, PG3, PG4, PG5, PG6, PG7,
    PG8, PG9, PG10, PG11, PG12, PG13, PG14, PG15, PH0, PH1, PH2, PH3, PH4, PH5, PH6, PH7, PH8, PH9,
    PH10, PH11, PH12, PH13, PH14, PH15, PI0, PI1, PI2, PI3, PI4, PI5, PI6, PI7, PI8, PI9, PI10,
    PI11, PI12, PI13, PI14, PI15, PJ0, PJ1, PJ2, PJ3, PJ4, PJ5, PJ6, PJ7, PJ8, PJ9, PJ10, PJ11,
    PJ12, PJ13, PJ14, PJ15, PK0, PK1, PK2, PK3, PK4, PK5, PK6, PK7, PK8, PK9, PK10, PK11, PK12,
    PK13, PK14, PK15, HASH, I2C1, I2C3, I2C4, IWDG1, JPEG, LPTIM1, LPTIM2, LPTIM3, LPUART1, LTDC,
    MDIOS, MDMA, OCTOSPI1, OCTOSPI2, OCTOSPIM, OPAMP1, OTFDEC1, PWR, RCC, RNG, RTC, SAI2, SDMMC1,
    SDMMC2, SPDIFRX, SPI1, SPI2, SPI3, SPI6, SWPMI1, SYSCFG, TIM1, TIM12, TIM13, TIM14, TIM15,
    TIM16, TIM17, TIM2, TIM3, TIM4, TIM5, TIM6, TIM7, TIM8, UART4, UART5, UART7, USART1, USART2,
    USART3, USART6, USB_OTG_HS, VREFBUF, WWDG1
);
