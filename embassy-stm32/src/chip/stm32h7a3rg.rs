...
peripherals!(
    ...
    EXTI13, EXTI14, EXTI15, ADC1, ADC2, BDMA1, BDMA2, COMP1, DAC1, DAC2, DMA2D, DTS, FDCAN1,
    ...
    PK13, PK14, PK15, I2C1, I2C3, I2C4, IWDG1, JPEG, LPTIM1, LPTIM2, LPTIM3, LPUART1, LTDC, MDIOS,
    MDMA, OCTOSPI1, OCTOSPI2, OCTOSPIM, OPAMP1, PWR, RCC, RNG, RTC, SAI2, SDMMC1, SDMMC2, SPDIFRX,
    SPI1, SPI2, SPI3, SPI6, SWPMI1, SYSCFG, TIM1, TIM12, TIM13, TIM14, TIM15, TIM16, TIM17, TIM2,
    TIM3, TIM4, TIM5, TIM6, TIM7, TIM8, UART4, UART5, UART7, USART1, USART2, USART3, USART6,
