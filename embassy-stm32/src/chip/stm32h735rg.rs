...
peripherals!(
    ...
    DTS, FDCAN1, FDCAN2, FMAC, PA0, PA1, PA2, PA3, PA4, PA5, PA6, PA7, PA8, PA9, PA10, PA11, PA12,
    ...
    PK10, PK11, PK12, PK13, PK14, PK15, HASH, I2C1, I2C2, I2C3, I2C4, IWDG1, LPTIM1, LPTIM2,
    LPTIM3, LPTIM4, LPTIM5, LPUART1, LTDC, MDIOS, MDMA, OCTOSPI1, OCTOSPI2, OCTOSPIM, OPAMP1,
    OTFDEC1, OTFDEC2, PSSI, PWR, RCC, RNG, RTC, SDMMC1, SDMMC2, SPI1, SPI2, SPI3, SPI6, SWPMI1,
    SYSCFG, TIM1, TIM12, TIM13, TIM14, TIM15, TIM16, TIM17, TIM2, TIM23, TIM24, TIM3, TIM4, TIM5,
    TIM6, TIM7, TIM8, UART4, UART5, UART7, USART1, USART2, USART3, USB_OTG_HS, VREFBUF, WWDG1
);
