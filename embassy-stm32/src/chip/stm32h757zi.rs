...
peripherals!(
    ...
    EXTI13, EXTI14, EXTI15, ADC1, ADC2, ADC3, BDMA, COMP1, COMP2, CRYP, DAC1, DCMI, DMA2D, ETH,
    FDCAN1, FDCAN2, PA0, PA1, PA2, PA3, PA4, PA5, PA6, PA7, PA8, PA9, PA10, PA11, PA12, PA13, PA14,
    ...
    PK13, PK14, PK15, HASH, I2C1, I2C2, I2C3, I2C4, IWDG1, IWDG2, JPEG, LPTIM1, LPTIM2, LPTIM3,
    LPTIM4, LPTIM5, LPUART1, LTDC, MDIOS, MDMA, OPAMP1, OPAMP2, PWR, QUADSPI, RCC, RNG, RTC, SAI1,
    SAI2, SAI3, SAI4, SDMMC1, SDMMC2, SPI1, SPI2, SPI3, SPI4, SPI6, SWPMI1, SYSCFG, TIM1, TIM12,
    TIM13, TIM14, TIM15, TIM16, TIM17, TIM2, TIM3, TIM4, TIM5, TIM6, TIM7, TIM8, UART4, UART5,
    UART7, UART8, USART1, USART2, USART3, USART6, USB_OTG_FS, USB_OTG_HS, VREFBUF, WWDG1, WWDG2
);
