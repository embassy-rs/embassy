...
peripherals!(
    ...
    EXTI13, EXTI14, EXTI15, ADC1, ADC2, BDMA1, BDMA2, COMP1, COMP2, DAC1, DAC2, DCMI, DMA2D, DTS,
    FDCAN1, FDCAN2, GFXMMU, PA0, PA1, PA2, PA3, PA4, PA5, PA6, PA7, PA8, PA9, PA10, PA11, PA12,
    ...
    PK11, PK12, PK13, PK14, PK15, I2C1, I2C2, I2C3, I2C4, IWDG1, JPEG, LPTIM1, LPTIM2, LPTIM3,
    LPUART1, LTDC, MDIOS, MDMA, OCTOSPI1, OCTOSPI2, OCTOSPIM, OPAMP1, OPAMP2, PSSI, PWR, RCC, RNG,
    RTC, SAI1, SAI2, SDMMC1, SDMMC2, SPDIFRX, SPI1, SPI2, SPI3, SPI4, SPI6, SWPMI1, SYSCFG, TIM1,
    TIM12, TIM13, TIM14, TIM15, TIM16, TIM17, TIM2, TIM3, TIM4, TIM5, TIM6, TIM7, TIM8, UART4,
    UART5, UART7, UART8, UART9, USART1, USART10, USART2, USART3, USART6, USB_OTG_HS, VREFBUF,
    WWDG1
);
