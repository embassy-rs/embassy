...
peripherals!(
    ...
    SAI2, SAI3, SAI4, SDMMC1, SDMMC2, SPI1, SPI2, SPI3, SPI4, SPI5, SPI6, SWPMI1, SYSCFG, TIM1,
    TIM12, TIM13, TIM14, TIM15, TIM16, TIM17, TIM2, TIM3, TIM4, TIM5, TIM6, TIM7, TIM8, UART4,
    UART5, UART7, UART8, USART1, USART2, USART3, USART6, USB_OTG_FS, USB_OTG_HS, VREFBUF, WWDG1,
    WWDG2
);
