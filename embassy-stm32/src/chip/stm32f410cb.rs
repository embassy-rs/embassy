...
peripherals!(
    ...
    EXTI13, EXTI14, EXTI15, ADC1, DAC, EXTI, FMPI2C1, PA0, PA1, PA2, PA3, PA4, PA5, PA6, PA7, PA8,
    ...
    PH12, PH13, PH14, PH15, I2C1, I2C2, IWDG, LPTIM1, RCC, RNG, RTC, SPI1, SPI2, SPI5, SYSCFG,
    TIM1, TIM11, TIM5, TIM6, TIM9, USART1, USART2, USART6, WWDG
);
