...
pub const TIM1: timer::Tim_gp16 = timer::Tim_gp16(0x40012c00 as _);
...
embassy_extras::peripherals!(
    ...
    PH6, PH7, PH8, PH9, PH10, PH11, PH12, PH13, PH14, PH15, RNG, SPI1, SPI3, SYSCFG, TIM1, TIM15,
    TIM16, TIM2, TIM6, TIM7, USART1, USART2
);
