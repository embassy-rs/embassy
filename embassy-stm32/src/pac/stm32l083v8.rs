...
pub const RNG: rng::Rng = rng::Rng(0x40025000 as _);
impl_rng!(RNG, AES_RNG_LPUART1);
...
pub const USART5: usart::Usart = usart::Usart(0x40005000 as _);
impl_usart!(USART5);
impl_usart_pin!(USART5, TxPin, PB3, 6);
impl_usart_pin!(USART5, RxPin, PB4, 6);
impl_usart_pin!(USART5, RtsPin, PB5, 6);
impl_usart_pin!(USART5, CkPin, PB5, 6);
impl_usart_pin!(USART5, TxPin, PC12, 2);
impl_usart_pin!(USART5, RxPin, PD2, 6);
impl_usart_pin!(USART5, TxPin, PE10, 6);
impl_usart_pin!(USART5, RxPin, PE11, 6);
impl_usart_pin!(USART5, RtsPin, PE7, 6);
impl_usart_pin!(USART5, CkPin, PE7, 6);
pub use regs::dma_v1 as dma;
pub use regs::exti_v1 as exti;
pub use regs::gpio_v2 as gpio;
pub use regs::rcc_l0 as rcc;
pub use regs::rng_v1 as rng;
pub use regs::syscfg_l0 as syscfg;
...
peripherals!(
    ...
    PH6, PH7, PH8, PH9, PH10, PH11, PH12, PH13, PH14, PH15, RCC, RNG, SYSCFG, USART1, USART2,
    USART4, USART5
);
