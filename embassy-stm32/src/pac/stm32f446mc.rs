...
impl_spi_pin!(SPI4, Sck, PG11, 6);
impl_spi_pin!(SPI4, Miso, PG12, 6);
impl_spi_pin!(SPI4, Mosi, PG13, 6);
...
peripherals!(
    ...
    PH12, PH13, PH14, PH15, SPI1, SPI2, SPI3, SPI4, SYSCFG, USART1, USART2, USART3, USART6
);
