...
impl_i2c_pin!(I2C2, SdaPin, PB3, 4);
impl_i2c_pin!(I2C2, SdaPin, PC12, 4);
...
impl_i2c_pin!(I2C3, SdaPin, PB4, 4);
...
impl_spi_pin!(SPI2, MosiPin, PC1, 7);
...
impl_spi!(SPI3, APB1);
impl_spi_pin!(SPI3, MosiPin, PB0, 7);
...
impl_spi_pin!(SPI4, SckPin, PG11, 6);
impl_spi_pin!(SPI4, MisoPin, PG12, 6);
impl_spi_pin!(SPI4, MosiPin, PG13, 6);
...
embassy_extras::peripherals!(
    ...
    PH12, PH13, PH14, PH15, I2C1, I2C2, I2C3, SPI1, SPI2, SPI3, SPI4, SYSCFG, USART1, USART2,
    USART3, USART6
);
