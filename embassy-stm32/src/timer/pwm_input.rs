...
impl<'d, T: GeneralInstance4Channel> PwmInput<'d, T> {
    ...
    pub fn new_ch1(tim: Peri<'d, T>, pin: Peri<'d, impl Channel1Pin<T>>, pull: Pull, freq: Hertz) -> Self {
    ...
    /// Create a new PWM input driver.
    pub fn new_ch2(tim: Peri<'d, T>, pin: Peri<'d, impl Channel2Pin<T>>, pull: Pull, freq: Hertz) -> Self {
        pin.set_as_af(pin.af_num(), AfType::input(pull));
