...
use stm32wb_hci::vendor::event::{GattProcedureStatus, VendorEvent};
    ...
    match event {
        VendorEvent::GattAttributeModified(e) => {
            ...
            Some(GattEvent::AttributeModified {
                ...
                // Current stm32wb-hci release does not expose the offset field.
                offset: 0,
                data,
            })
        }
...
pub fn client_events_from_vendor_event(event: &VendorEvent) -> heapless::Vec<GattClientEvent, 16> {
    ...
    match event {
        ...
        VendorEvent::AttFindInformationResponse(e) => {
            match e.handle_uuid_pair_iter() {
