...
use crate::pac::dma0::vals::Halt;
use crate::pac::edma_0_tcd0::regs::{TcdAttr, TcdBiterElinkno, TcdCiterElinkno, TcdCsr};
use crate::pac::edma_0_tcd0::vals::{Bwc, Dreq, Esg, Size, Start};
...
impl WordSize {
    ...
    pub const fn to_hw_size(self) -> Size {
        match self {
            ...
            WordSize::FourBytes => Size::THIRTYTWO_BYTE,
        }
    }
