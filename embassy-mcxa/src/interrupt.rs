...
pub struct Adc0;
pub const ADC0: Adc0 = Adc0;

impl InterruptExt for Adc0 {
    /// Clear any pending ADC0 in NVIC.
    #[inline]
    fn unpend(&self) {
        cortex_m::peripheral::NVIC::unpend(Interrupt::ADC0);
    }

    /// Set NVIC priority for ADC0.
    #[inline]
    fn set_priority(&self, priority: Priority) {
        unsafe {
            let mut nvic = cortex_m::peripheral::Peripherals::steal().NVIC;
            nvic.set_priority(Interrupt::ADC0, u8::from(priority));
        }
    }
    ...
    #[inline]
    unsafe fn enable(&self) {
        cortex_m::peripheral::NVIC::unmask(Interrupt::ADC0);
    }

    /// Disable ADC0 in NVIC.
    #[inline]
    unsafe fn disable(&self) {
        cortex_m::peripheral::NVIC::mask(Interrupt::ADC0);
    }

    /// Check if ADC0 is pending in NVIC.
    #[inline]
    fn is_pending(&self) -> bool {
        cortex_m::peripheral::NVIC::is_pending(Interrupt::ADC0)
    }
}
...
impl InterruptExt for Adc2 {
    /// Clear any pending ADC2 in NVIC.
    #[inline]
    fn unpend(&self) {
        cortex_m::peripheral::NVIC::unpend(Interrupt::ADC2);
    }

    /// Set NVIC priority for ADC2.
    #[inline]
    fn set_priority(&self, priority: Priority) {
        unsafe {
            let mut nvic = cortex_m::peripheral::Peripherals::steal().NVIC;
            nvic.set_priority(Interrupt::ADC2, u8::from(priority));
        }
    }
    ...
    #[inline]
    unsafe fn enable(&self) {
        cortex_m::peripheral::NVIC::unmask(Interrupt::ADC2);
    }

    /// Disable ADC2 in NVIC.
    #[inline]
    unsafe fn disable(&self) {
        cortex_m::peripheral::NVIC::mask(Interrupt::ADC2);
    }

    /// Check if ADC2 is pending in NVIC.
    #[inline]
    fn is_pending(&self) -> bool {
        cortex_m::peripheral::NVIC::is_pending(Interrupt::ADC2)
    }
}
...
impl InterruptExt for Adc3 {
    /// Clear any pending ADC3 in NVIC.
    #[inline]
    fn unpend(&self) {
        cortex_m::peripheral::NVIC::unpend(Interrupt::ADC3);
    }

    /// Set NVIC priority for ADC3.
    #[inline]
    fn set_priority(&self, priority: Priority) {
        unsafe {
            let mut nvic = cortex_m::peripheral::Peripherals::steal().NVIC;
            nvic.set_priority(Interrupt::ADC3, u8::from(priority));
        }
    }
    ...
    /// Disable ADC3 in NVIC.
    #[inline]
    unsafe fn disable(&self) {
        cortex_m::peripheral::NVIC::mask(Interrupt::ADC3);
    }

    /// Check if ADC3 is pending in NVIC.
    #[inline]
    fn is_pending(&self) -> bool {
        cortex_m::peripheral::NVIC::is_pending(Interrupt::ADC3)
    }
}
