...
pub(crate) mod peripheral_gating {
    ...
    impl_cc_gate!(DMA0, mrcc_glb_acc0, mrcc_glb_rst0, dma, NoConfig);

    impl_cc_gate!(GPIO0, mrcc_glb_acc1, mrcc_glb_rst1, gpio0, NoConfig);
    impl_cc_gate!(GPIO1, mrcc_glb_acc1, mrcc_glb_rst1, gpio1, NoConfig);
