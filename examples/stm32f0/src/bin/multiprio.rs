...
async fn run_med() {
    loop {
        ...
        cortex_m::asm::delay(8_000_000); // At least 8_000_000 CPU cycles (could be ~1 second)
...
async fn run_low() {
    loop {
        ...
        // Spin-wait to simulate a long CPU computation
        cortex_m::asm::delay(16_000_000); // At least 16_000_000 CPU cycles (could be ~2 seconds)
