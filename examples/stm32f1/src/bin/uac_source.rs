...
async fn sine_wave_gen(
    ...
    loop {
        ...
        // Honor the advertised mute control.
...
async fn main(spawner: Spawner) {
    ...
    let AudioSource {
        ...
        SourceConfig {
            sample_rates_hz: &SUPPORTED_SAMPLE_RATES,
            sample_width: SAMPLE_WIDTH,
            channels: &[uac1::Channel::LeftFront, uac1::Channel::RightFront],
            input_terminal: TerminalType::MiniDisk,
            feature_unit: FeatureUnitControls::ALL,
        },
    );
