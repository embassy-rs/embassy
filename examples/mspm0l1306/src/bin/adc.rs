//! This example measures from the TMP6131 thermistor on the LP-MSPM0L1306 board.
//!
//! J1 must be set to connect the thermistor to PA15 for this example to work.
...
async fn main(_spawner: Spawner) -> ! {
    ...
    let mut thermistor_pin = p.PA15.reborrow_adc();
