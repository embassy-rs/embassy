...
async fn main(_spawner: embassy_executor::Spawner) {
    ...
    // 256-bit key
    let key: [u8; 32] = [
        0xD3, 0x46, 0xD1, 0x1A, 0x71, 0x17, 0xCE, 0x04, 0x08, 0x08, 0x95, 0x70, 0x77, 0x78, 0x28, 0x7C,
        0x40, 0xF5, 0xF4, 0x73, 0xA9, 0xA8, 0xF2, 0xB1, 0x57, 0x0F, 0x61, 0x37, 0x46, 0x69, 0x75, 0x1A,
    ];
    ...
    let nonce: [u8; 12] = [
        0x05, 0xC8, 0xCC, 0x77, 0x32, 0xB3, 0xB4, 0x7F, 0x08, 0xAF, 0x1D, 0xAF,
    ];
