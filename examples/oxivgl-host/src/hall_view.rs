//! Host copy of the JSON-driven hall lighting [`HallView`].
//!
//! Uses the fixed 5-column shell layout from the RVT50 widget demo; JSON config
//! supplies strings and field metadata only.
//!
//! Keep in sync with `examples/rvt50hqsnwc00-b/src/oxivgl/hall_view.rs`.
