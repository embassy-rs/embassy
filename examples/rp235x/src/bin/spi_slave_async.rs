//! This example shows how to use SPI (Serial Peripheral Interface) master and slave in the RP235x chip.
//! Note: The SPI slave on the RP235x requires CS to be toggled for each byte
//!
