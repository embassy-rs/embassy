...
pub const LVGL_BUF_BYTES: usize = crate::board::DISPLAY_WIDTH * COLOR_BUF_LINES * 2;
...
pub async fn run_widget_demo(bufs: &'static mut LvglBuffers<{ LVGL_BUF_BYTES }>) -> ! {
    let driver = LvglDriver::init(DISPLAY_WIDTH as i32, crate::board::DISPLAY_HEIGHT as i32);
    let _display = PanelDisplay::init(DISPLAY_WIDTH as i32, crate::board::DISPLAY_HEIGHT as i32, bufs);
