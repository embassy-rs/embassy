//! gen4-RP2350 platform glue for OxivGL (partial LVGL + continuous PIO scan-out).
...
use crate::oxivgl::display::{PsramDisplay, LVGL_BUF_BYTES};
...
pub async fn run_widget_demo(
    ...
    crate::oxivgl::display::prefill_background(0xFFFF);
